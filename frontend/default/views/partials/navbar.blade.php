<nav class="navbar gray-bg mb-0">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" style="padding:0px; " href="{{ base_url('frontend/page/home3') }}">  <img src="{{ base_url('uploads/gallery/logo.png') }}" alt="usman.png" style="margin-top:0px;padding:0px; height:50px; width:80px"> </a>
            </div>
