...
function getCampus($campusID=0,$colone='2',$coltwo='6',$colthree='4') {
    ...
    $ci->lang->load('campus', $language);



    $getCampus = $ci->getCampusDetails();
    ...
    echo '<label for="campusID" class="col-sm-'.$colone.' control-label">';

    echo $ci->lang->line("campus_name"); 

    echo '<span class="text-red">*</span></label>';



    echo '<div class="col-sm-'.$coltwo.'">';

    if(count($getCampus) > 1){                    

        $campusArray = array(0 => $ci->lang->line("select_campus"));
    ...
    echo form_dropdown("campusID", $campusArray, set_value("campusID",$campusID), "id='campusID' onchange='getInfoByCampus(this.value)'   class='form-control select2'");



    echo '</div>';

    echo '<span class="col-sm-'.$colthree.' control-label">';

    echo form_error('campusID'); 
...
function getCampusView($campusID=0,$col='3') {
    ...
    echo '<div class="col-md-'.$col.' control-label">';
    ...
    echo '<label for="campusID" class="control-label">';
...
function CampusReport($campusID=0,$col='3') {
    ...
    $getCampus = $ci->getCampusReport();

    $campusID   = $ci->session->userdata('campus_id');
    ...
    if(count($getCampus) > 1){                    
        ...
        $campusArray = array(0 => $ci->lang->line("all_campus"));
    ...
    echo form_dropdown("campusID", $campusArray, set_value("campusID",$campusID), "id='campusID' onchange='getInfoByCampusReport(this.value)'   class='form-control select2'");
...
function campusView($setcampusID=0,$col='2') {
    ...
    echo '<div class="col-md-'.$col.' pull-right drop-marg">';
    ...
    echo form_dropdown("campusID", $campusArray, set_value("campusID",$setcampusID), "id='campusID' onchange='getInfoCampusView(this.value)'   class='form-control select2'");
...
function campuses() {
    ...
    $getCampus = $ci->getCampusesDetails();
...
function reportheader($setting, $schoolyear, $pdf = FALSE) {
    ...
    if(!empty($setting) && !empty($schoolyear)) {
