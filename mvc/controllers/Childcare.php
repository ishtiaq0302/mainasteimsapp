...
class Childcare extends Admin_Controller {
	...
	public function index() {
        ...
        $this->data['drop_receive'] = $this->childcare_m->get_join_childcare_all($schoolyearID,NULL,$campusID);
		...
		if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) {
			...
			if($_POST) {
				...
				if ($this->form_validation->run() == FALSE) { 
	                ...
	                $data["campusID"] = $this->input->post('campusID');
	                ...
	                redirect(base_url('childcare/index/'.$data["campusID"]));
				}
			} else {
				$this->data["subview"] = "childcare/add";
				$this->load->view('_layout_main', $this->data);
	...
	public function edit() {
		if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) {
			...
			if((int)$id) {
				...
				$this->data['campusID']=$this->data['careinfo']->campusID;
				$this->data['classesID']=$this->data['careinfo']->classesID;
				if(!empty($this->data['careinfo'])) {
			        $this->data['parents'] = $this->parents_m->get_parents();
			        $this->data['classes'] = $this->classes_m->get_classes();
