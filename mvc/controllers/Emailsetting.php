...
*/
	...
	public function index() {
        ...
        $emailsetting = 1;
        $this->data['emailsetting'] = $this->emailsetting_m->get_emailsettings();
        ...
        if(!empty($emailsetting)) {
            if($_POST) {
                ...
                if ($this->form_validation->run() == FALSE) {
                    ...
                    $this->emailsetting_m->insertorupdates($array);
            ...
            $this->data['emailsetting'] = array('email_engine'=>'','smtp_password'=>'','smtp_port'=>'','smtp_security'=>'','smtp_server'=>'','smtp_username'=>'');
