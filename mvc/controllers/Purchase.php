...
class Purchase extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        ...
        $this->data['purchases'] = $this->purchase_m->get_purchase_with_alls($campusID);
    ...
    public function add() {
        ...
        if($_POST) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                redirect(base_url("purchase/index/".$array['campusID']));
            }
        } else {
            $this->data["subview"] = "purchase/add";
            $this->load->view('_layout_main', $this->data);
    ...
    public function edit() {
        ...
        if((int)$id) {
            ...
            $this->data['campusID']=$this->data['purchase']->campusID;
            $this->data['vendorID']=$this->data['purchase']->vendorID;
            $this->data['assetID']=$this->data['purchase']->assetID;
            $this->data['purchased_by']=$this->data['purchase']->purchased_by;
