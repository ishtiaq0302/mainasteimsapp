...
class Productwarehouse extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        ...
        $this->data['productwarehouses'] = $this->productwarehouse_m->get_order_by_productwarehouse(array('campusID'=>$campusID));
    ...
    public function unique_productwarehousename() {
        ...
        if((int)$id) {
            $productwarehouse = $this->productwarehouse_m->get_order_by_productwarehouse(array("productwarehousename" => $this->input->post("productwarehousename"), 'productwarehousecode' => $this->input->post('productwarehousecode'), "productwarehouseID !=" => $id, "campusID" => $this->input->post("campusID")));
            ...
            $productwarehouse = $this->productwarehouse_m->get_order_by_productwarehouse(array("productwarehousename" => $this->input->post("productwarehousename"), 'productwarehousecode' => $this->input->post('productwarehousecode'), "campusID" => $this->input->post("campusID")));
            if(!empty($productwarehouse)) {
                $this->form_validation->set_message("unique_productwarehousename", "The %s is already exists.");
                return FALSE;
            }
    ...
    public function add() {
        if($_POST) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                redirect(base_url("productwarehouse/index/".$array['campusID']));
            }
        } else {
            $this->data["subview"] = "productwarehouse/add";
            $this->load->view('_layout_main', $this->data);
    ...
    public function edit() {
        ...
        if((int)$id) {
            ...
            $this->data['campusID'] = $this->data['productwarehouse']->campusID;
    ...
    public function unique_warehousecode() {
        $id = htmlentities(escapeString($this->uri->segment(3)));
        if((int)$id) {
            $productwarehouse = $this->productwarehouse_m->get_order_by_productwarehouse(array("productwarehousecode" => $this->input->post("productwarehousecode"), "productwarehouseID !=" => $id, "campusID" => $this->input->post("campusID")));
            if(!empty($productwarehouse)) {
            ...
            $productwarehouse = $this->productwarehouse_m->get_order_by_productwarehouse(array("productwarehousecode" => $this->input->post("productwarehousecode"), "campusID" => $this->input->post("campusID")));
