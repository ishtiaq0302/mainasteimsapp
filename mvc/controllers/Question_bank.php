...
class Question_bank extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        ...
        $this->data['question_banks'] = $this->question_bank_m->get_order_by_question_bank(array('campusID'=>$campusID));
    ...
    public function edit() {
        ...
        if((int)$questionID) {
            ...
            $this->data['campusID']=$this->data['question_bank']->campusID;
    ...
    public function view() {
        ...
        if((int)$questionID) {
            ...
            $this->data['campusID'] =  $questionBank->campusID;
    ...
    public function delete() {
        ...
        if((int)$id) {
            ...
            if(!empty($this->data['question_bank'])) {
    ...
    public function print_preview() {
        if(permissionChecker('question_bank_view')) {
            ...
            if((int)$id) {
                ...
                $this->data['question'] =  $questionBank;
                $this->data["siteinfos"] = $this->site_m->get_site_($questionBank->campusID);
                if(!empty($questionBank)) {
                    $allOptions = $this->question_option_m->get_order_by_question_option(array('questionID'=>$questionBank->questionBankID));
                    $options = [];
                    $oc = 1;
