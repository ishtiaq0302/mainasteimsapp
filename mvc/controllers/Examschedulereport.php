		...
		if(permissionChecker('examschedulereport')) {
			if($_POST) {
				...
				if ($this->form_validation->run() == FALSE) {
					...
					if($campusID>0)
					{
						$this->data['classes'] = pluck($this->classes_m->get_order_by_classes(array('campusID'=>$campusID)),'classes','classesID');
					}else{
