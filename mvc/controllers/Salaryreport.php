    ...
    public function getUser() {
        ...
        if((int)$usertypeID) {
            ...
            if($usertypeID == 1) {
                ...
                if($campusID>0){
                    $users = $this->teacher_m->get_order_by_teacher(array('campusID'=>$campusID));
                }else{
