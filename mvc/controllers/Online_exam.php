...
class Online_exam extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        ...
        $this->data['online_exams'] = $this->online_exam_m->get_order_by_online_exam(array('schoolYearID' => $schoolyearID,'campusID' => $campusID));
    ...
    public function edit() {
        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) {
            ...
            if((int)$id) {
                ...
                $this->data['campusID']=$this->data['online_exam']->campusID;
                $this->data['classesID']=$this->data['online_exam']->classID;
                $this->data['studentGroupID']=$this->data['online_exam']->studentGroupID;
    ...
    public function delete() {
        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) {
            ...
            if((int)$id) {
                $schoolYearID = $this->session->userdata('defaultschoolyearID');
                $this->data['online_exam'] = $this->online_exam_m->get_single_online_exam(array('onlineExamID' => $id, 'schoolYearID' => $schoolYearID));
                if(!empty($this->data['online_exam'])) {
    ...
    public function addquestion() {
        ...
        if(permissionChecker('online_exam_add')) {
            ...
            if((int)$onlineExamID) {
                ...
                $this->data['campusID']=$onlineExam->campusID;
                if(!empty($onlineExam)) {
    ...
    public function showQuestions() {
        ...
        /*if($inputs['campusID']) {*/
            $where['campusID'] = $inputs['campusID'];
        /*}*/
