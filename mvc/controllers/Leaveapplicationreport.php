...
*/
        ...
        if(permissionChecker('leaveapplicationreport')) {
            if($_POST) {
                ...
                if ($this->form_validation->run() == FALSE) {
                    ...
                    if($this->data['classesID']!=0){
                        $single_class  = $this->classes_m->general_get_single_classes(array('classesID'=>$this->data['classesID']));
                        $this->data["siteinfos"] = $this->site_m->get_site_($single_class->campusID);
                    }else{
    ...
    public function pdf() {
        if(permissionChecker('leaveapplicationreport')) {
            ...
            if($classesID!=0){
                        $single_class  = $this->classes_m->general_get_single_classes(array('classesID'=>$classesID));
                        $this->data["siteinfos"] = $this->site_m->get_site_($single_class->campusID);
                    }else{
                        $this->data["siteinfos"] = $this->site_m->get_site_(1);
                    }
