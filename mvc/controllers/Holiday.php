...
*/
	...
	public function index() {
		...
		$this->data['holidays'] = $this->holiday_m->get_order_by_holiday(array('schoolyearID' => $schoolyearID,'campusID' => $campusID));
		...
		if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID') || $this->session->userdata('usertypeID') == 1)) {
			...
			if($_POST) {
				...
				if ($this->form_validation->run() == FALSE) {
					...
					redirect(base_url("holiday/index/".$array["campusID"]));			
				}
			} else {
				$this->data["subview"] = "holiday/add";
				$this->load->view('_layout_main', $this->data);
	...
	public function edit() {
		if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID') || $this->session->userdata('usertypeID') == 1)) {
			...
			if((int)$id) {
				...
				$this->data['campusID']=$this->data['holiday']->campusID;
	...
	public function print_preview() {
		if(permissionChecker('holiday_view')) {
			...
			if((int)$id) {
				$this->data['holiday'] = $this->holiday_m->get_single_holiday(array('schoolyearID' => $schoolyearID, 'holidayID' => $id));
				$this->data["siteinfos"] = $this->site_m->get_site_($this->data["holiday"]->campusID);
				if(!empty($this->data['holiday'])) {
