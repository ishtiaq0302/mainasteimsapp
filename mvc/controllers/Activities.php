...
*/
	...
	public function index() {
        ...
        $this->data['activitiescategories'] = pluck($this->activitiescategory_m->get_order_by_activitiescategory(array('campusID'=>$campusID)), 'obj', 'activitiescategoryID');

        $this->data['activities'] = $this->activities_m->get_order_by_activities(array('schoolyearID' => $schoolyearID,'campusID' => $campusID));
                    ...
                    if ($this->form_validation->run() == FALSE) {
                        ...
                        if($id) {
                            if(!empty($_FILES['attachment']['name'])){
                                $filesCount = !empty($_FILES['attachment']['name']);
                        ...
                        $this->session->set_flashdata('success', $this->lang->line('menu_success'));
                        redirect(base_url("activities/index/".$array['campusID']));
                    }
                } else {
                    $this->data["subview"] = "activities/add";
                    $this->load->view('_layout_main', $this->data);
