...
class Productsupplier extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        ...
        $this->data['suppliers'] = $this->productsupplier_m->get_order_by_productsupplier(array('campusID'=>$campusID));
    ...
    public function add() {
        if($_POST) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                redirect(base_url("productsupplier/index/".$array['campusID']));
            }
        } else {
            $this->data["subview"] = "productsupplier/add";
            $this->load->view('_layout_main', $this->data);
    ...
    public function edit() {
        ...
        if((int)$id) {
            ...
            $this->data['campusID'] = $this->data['productsupplier']->campusID;
    ...
    public function unique_companyname() {
        $id = htmlentities(escapeString($this->uri->segment(3)));
        if((int)$id) {
            $productsupplier = $this->productsupplier_m->get_order_by_productsupplier(array("productsuppliercompanyname" => $this->input->post("productsuppliercompanyname"), "productsupplierID !=" => $id, "campusID" => $this->input->post("campusID")));
            ...
            $productsupplier = $this->productsupplier_m->get_order_by_productsupplier(array("productsuppliercompanyname" => $this->input->post("productsuppliercompanyname"), "campusID" => $this->input->post("campusID")));
            if(!empty($productsupplier)) {
                $this->form_validation->set_message("unique_companyname", "The %s is already exists.");
                return FALSE;
            }
