...
*/
	...
	protected function rules() {
		$rules = array(
			...
			array(
				'field' => 'father_cnic',
				'label' => $this->lang->line("father_cnic"),
				'rules' => 'trim|xss_clean|max_length[60]'
			),
			array(
				'field' => 'father_qualification',
				'label' => $this->lang->line("father_qualification"),
				'rules' => 'trim|xss_clean|max_length[60]'
			),
			array(
				'field' => 'father_office_addresss',
				'label' => $this->lang->line("father_office_addresss"),
				'rules' => 'trim|xss_clean|max_length[200]'
			),
			array(
				'field' => 'father_nationality',
				'label' => $this->lang->line("father_nationality"),
				'rules' => 'trim|xss_clean|max_length[60]'
			),
			array(
				'field' => 'mother_phone',
			...
			array(
				'field' => 'mother_cnic',
				'label' => $this->lang->line("mother_cnic"),
				'rules' => 'trim|xss_clean|max_length[60]'
			),
			array(
				'field' => 'mother_office_addresss',
				'label' => $this->lang->line("mother_office_addresss"),
				'rules' => 'trim|xss_clean|max_length[200]'
			),
			array(
				'field' => 'mother_address',
				'label' => $this->lang->line("mother_address"),
				'rules' => 'trim|xss_clean|max_length[200]'
			),
			array(
				'field' => 'mother_qualification',
				'label' => $this->lang->line("mother_qualification"),
				'rules' => 'trim|xss_clean|max_length[60]'
			),
			array(
				'field' => 'mother_nationality',
				'label' => $this->lang->line("mother_nationality"),
				'rules' => 'trim|xss_clean|max_length[60]'
			),
			array(
				'field' => 'guardian_profession',
				'label' => $this->lang->line("guardian_profession"),
				'rules' => 'trim|xss_clean|max_length[60]'
			),
			array(
				'field' => 'guardian_cnic',
				'label' => $this->lang->line("guardian_cnic"),
				'rules' => 'trim|xss_clean|max_length[60]'
			),
			array(
				'field' => 'guardian_address',
				'label' => $this->lang->line("guardian_address"),
				'rules' => 'trim|xss_clean|max_length[200]'
			),
			array(
				'field' => 'guardian_qualification',
				'label' => $this->lang->line("guardian_qualification"),
				'rules' => 'trim|xss_clean|max_length[60]'
			),
			array(
				'field' => 'guardian_office_addresss',
				'label' => $this->lang->line("guardian_office_addresss"),
				'rules' => 'trim|xss_clean|max_length[200]'
			),
			array(
				'field' => 'guardian_nationality',
				'label' => $this->lang->line("guardian_nationality"),
				'rules' => 'trim|xss_clean|max_length[60]'
			),
			array(
				'field' => 'guardian_realation_with_child',
				'label' => $this->lang->line("guardian_realation_with_child"),
				'rules' => 'trim|xss_clean|max_length[60]'
			),
		);
		return $rules;
	...
	public function index() {
		...
		if($this->session->userdata('usertypeID') == 4 && $myProfile) {
			...
			$setcampusID=$this->uri->segment(3);
			$this->data['setcampusID']=$setcampusID;
			$this->data['parents'] = $this->parents_m->get_order_by_parents(array('campusID' => $setcampusID));
	...
	public function add() {
		...
		if($_POST) {
			...
			if ($this->form_validation->run() == FALSE) {
				...
				redirect(base_url("parents/index/".$array['campusID']));
	...
	public function edit() {
		...
		if ((int)$id) {
			...
			$this->data['campusID']=$this->data['parents']->campusID;
	...
	private function getView($parentsID) {
		if ((int)$parentsID) {
			...
			$this->data['campusID']=$parents->campusID;
			if(!empty($parents)) {
	...
	public function print_preview() {
		if(permissionChecker('parents_view') || (($this->session->userdata('usertypeID') == 4) && permissionChecker('parents') && ($this->session->userdata('loginuserID') == htmlentities(escapeString($this->uri->segment(3)))))) {
			...
			if((int)$parentsID) {
				...
				$this->data["siteinfos"] = $this->site_m->get_site_($this->data["parents"]->campusID);
