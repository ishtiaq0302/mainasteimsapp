...
*/
	...
	public function queryArray($array) {
		...
		$this->data['schoolyearName'] = !empty($schoolyear) ? $schoolyear->schoolyear : '';
	...
	public function pdf() {
		if(permissionChecker('onlineadmissionreport')) {
			...
			$phone        = htmlentities(escapeString($this->uri->segment(7)));
			$admissionID  = htmlentities(escapeString($this->uri->segment(8)));
