...
class Asset_assignment extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        ...
        $this->data['asset_assignments'] = $this->asset_assignment_m->get_asset_assignment_with_userypeIDs($campusID);
    ...
    public function add() {
        ...
        if($_POST) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                redirect(base_url("asset_assignment/index/".$array['campusID']));
            }
        } else {
            $this->data["subview"] = "/asset_assignment/add";
            $this->load->view('_layout_main', $this->data);
    ...
    public function edit() {
        ...
        if((int)$id) {
            ...
            $this->data['campusID']=$this->data['asset_assignment']->campusID;
            $this->data['asset_locationID']=$this->data['asset_assignment']->asset_locationID;
            $this->data['assetID']=$this->data['asset_assignment']->assetID;
            $this->data['usertypeID']=$this->data['asset_assignment']->usertypeID;
    ...
    public function view() {
        ...
        if((int)$id) {
            ...
            if(!empty($this->data['asset_assignment'])) {
                $usertypeID = $this->data['asset_assignment']->usertypeID;
    ...
    public function print_preview() {
        ...
        if((int)$id) {
            $this->data['asset_assignment'] = $this->asset_assignment_m->get_single_asset_assignment_with_usertypeID(array('asset_assignmentID' => $id));
            $this->data["siteinfos"] = $this->site_m->get_site_($this->data["asset_assignment"]->campusID);
            $this->data['usertypes'] = pluck($this->usertype_m->get_usertype(), 'usertype', 'usertypeID');
