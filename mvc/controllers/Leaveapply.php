...
class Leaveapply extends Admin_Controller
{
    ...
    */
    ...
    public function index() {
        ...
        $this->data['myleaveapplications'] = $this->leaveapplication_m->get_order_by_leaveapplication(array('schoolyearID' => $schoolyearID, 'create_usertypeID' => $this->session->userdata('usertypeID'), 'create_userID' => $this->session->userdata('loginuserID'),'campusID' => $campusID));
    ...
    public function add() {
        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) {
            ...
            foreach ($this->data['usertypes'] as $usertypeKey => $usertype) {
                if (!empty($usertype) && $usertype->usertypeID == 3 || $usertype->usertypeID == 4) {
    ...
    public function edit() {
        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) {
            ...
            if((int)$id) {
                ...
                $this->data['campusID']=$this->data['leaveapplication']->campusID;
                if (!empty($this->data['leaveapplication'])) {
                    if($this->data['leaveapplication']->status == NULL) {
                        if($this->data['leaveapplication']->create_userID == $this->session->userdata('loginuserID') && $this->data['leaveapplication']->create_usertypeID == $this->session->userdata('usertypeID')) {
                            ...
                            $this->data['users'] = $this->getuserlistbyrole($this->data['usertypeID'], 0, FALSE, $this->data['campusID']);
    ...
    public function usercall() {
        ...
        $campusID = explode('/', $usertypeID, 2)[1];
        $usertypeID = strtok($usertypeID, '/');

        if((int)$usertypeID) {
            $this->data['users'] = array();
            if($usertypeID == 1) {
                $this->data['users'] = $this->systemadmin_m->get_order_by_systemadmin(array('campus_id' => $campusID));
                ...
                $this->data['users'] = $this->teacher_m->get_order_by_teacher(array('campusID' => $campusID));
                echo "<option value='0'>", $this->lang->line("leaveapply_select_user"),"</option>";
                if(!empty($this->data['users'])) {
                    foreach ($this->data['users'] as $value) {
                ...
                $this->data['users'] = $this->studentrelation_m->get_order_by_student(array('schoolyearID' => $schoolyearID,'campusID' => $campusID));
                echo "<option value='0'>", $this->lang->line("leaveapply_select_user"),"</option>";
                if(!empty($this->data['users'])) {
                    foreach ($this->data['users'] as $value) {
                ...
                $this->data['users'] = $this->parents_m->get_order_by_parents(array('campusID' => $campusID));
                echo "<option value='0'>", $this->lang->line("leaveapply_select_user"),"</option>";
                if(!empty($this->data['users'])) {
                    foreach ($this->data['users'] as $value) {
                ...
                $this->data['users'] = $this->user_m->get_order_by_user(array('usertypeID' => $usertypeID,'campusID' => $campusID));
                echo "<option value='0'>", $this->lang->line("leaveapply_select_user"),"</option>";
                if(!empty($this->data['users'])) {
                    foreach ($this->data['users'] as $value) {
    ...
    private function getuserlistbyrole($usertypeID, $classesID = 0, $obj = FALSE, $campusID = 0)  {
        $userArray = [];
        $schoolyearID = $this->session->userdata('defaultschoolyearID');
        ...
        if($usertypeID == 1) {
            ...
            $teachers = $this->teacher_m->get_order_by_teacher(array('campusID' => $campusID));
            if($obj == FALSE) {
                $userArray = array(0 => $this->lang->line("leaveapply_select_user"));
                if(!empty($teachers)) {
            ...
            if($classesID == 0) {
                $students = $this->studentrelation_m->get_order_by_student(array('srschoolyearID' => $schoolyearID,'campusID' => $campusID));
            } else {
                $students = $this->studentrelation_m->get_order_by_student(array('srschoolyearID' => $schoolyearID, 'srclassesID' => $classesID,'campusID' => $campusID));
            }
    ...
    public function view() {
        ...
        if ((int)$id) {
            ...
            $this->data['campusID']=$this->data['leaveapply']->campusID;
            if(!empty($this->data['leaveapply'])) {
    ...
    public function print_preview() {
        if(permissionChecker('leaveapply_view')) {
            ...
            if((int)$id) {
                ...
                $this->data['usertypes'] = pluck($this->usertype_m->get_usertype(),'usertype','usertypeID');
                $this->data['leaveapply'] = $this->leaveapplication_m->get_single_leaveapplication(array('leaveapplicationID' => $id, 'schoolyearID' => $schoolyearID));
                $this->data["siteinfos"] = $this->site_m->get_sites(1,$this->data["leaveapply"]->campusID);
                if(!empty($this->data['leaveapply'])) {
                    if(($this->data['leaveapply']->create_userID == $this->session->userdata('loginuserID')) && ($this->data['leaveapply']->create_usertypeID == $this->session->userdata('usertypeID'))) {
                        $leavecategory = $this->leavecategory_m->get_single_leavecategory(array('leavecategoryID' => $this->data['leaveapply']->leavecategoryID));
                        if(!empty($leavecategory)) {
