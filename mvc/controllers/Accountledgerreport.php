...
*/
	...
	public function queryArray($array) {
		...
		if(!empty($array['campusID'])) {
			$retArray['campusID']    = $array['campusID'];	
		}
		...
		$this->data['schoolyearName'] = !empty($schoolyear) ? $schoolyear->schoolyear : $this->lang->line('accountledgerreport_all_accademic_year');
		return $retArray;
	}
