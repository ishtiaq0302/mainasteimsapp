...
class Productsale extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        ...
        $this->data['productsales'] = $this->productsale_m->get_order_by_productsale(array('schoolyearID' => $schoolyearID,'campusID' => $campusID));
            ...
            if(!empty($productsales)) {
                foreach ($productsales as $productsale) {
                    if(isset($productsaleitems[$productsale->productsaleID])) {
                        if(!empty($productsaleitems[$productsale->productsaleID])) {
                    ...
                    if(isset($productsalepaids[$productsale->productsaleID])) {
                        if(!empty($productsalepaids[$productsale->productsaleID])) {
    ...
    public function view() {
        ...
        if((int)$id) {
            ...
            $this->data["siteinfos"] = $this->site_m->get_site_($this->data["productsale"]->campusID);

            $this->data['campusID']=$this->data['productsale']->campusID;
            ...
            if(permissionChecker('productsale_delete')) {
                if((int)$productsalepaidID) {
                    ...
                    if(!empty($productsalepaid)) {
                        ...
                        if(!empty($productsale) && $productsale->productsalerefund == 0) {
    ...
    public function edit() {
        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1) || ($this->session->userdata('defaultschoolyearID') == 5)) {
            ...
            if((int)$id) {
                ...
                if(!empty($this->data['productsale'])) {
