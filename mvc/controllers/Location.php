...
class Location extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        ...
        $this->data['locations'] = $this->location_m->get_order_by_location(array('campusID'=>$campusID));
    ...
    public function add() {
        ...
        if($_POST) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                redirect(base_url("location/index/".$array['campusID']));
            }
        } else {
            $this->data["subview"] = "location/add";
            $this->load->view('_layout_main', $this->data);
    ...
    public function edit() {
        ...
        if((int)$id) {
            ...
            $this->data['campusID']=$this->data['location']->campusID;
