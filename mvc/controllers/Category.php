...
*/
	...
	public function index() {
		...
		$this->data['categorys'] = $this->category_m->get_join_categorys($campusID);
	...
	public function add() {
		...
		if($_POST) {
			...
			if ($this->form_validation->run() == FALSE) {
				...
				redirect(base_url("category/index/".$array['campusID']));
			}
		} else {
			$this->data["subview"] = "category/add";
			$this->load->view('_layout_main', $this->data);
	...
	public function edit() {
		...
		if((int)$id) {
			...
			$this->data['campusID'] = $this->data['category']->campusID;
			$this->data['hostelID'] = $this->data['category']->hostelID;
