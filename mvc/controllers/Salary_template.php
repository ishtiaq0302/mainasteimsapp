...
class Salary_template extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        ...
        $this->data['salary_templates'] = $this->salary_template_m->get_order_by_salary_template(array('campusID'=>$campusID));
    ...
    public function edit() {
        ...
        if((int)$id) {
            ...
            $this->data['campusID']=$this->data['salary_template']->campusID;
    ...
    public function unique_salary_grades() {
        if($this->input->post('salary_grades')) {
            ...
            if((int)$id) {
                $salary_grades = $this->salary_template_m->get_single_salary_template(array('salary_grades' => $this->input->post("salary_grades"), 'salary_templateID !=' => $id, "campusID" => $this->input->post("campusID")));
                ...
                $salary_grades = $this->salary_template_m->get_single_salary_template(array('salary_grades' => $this->input->post("salary_grades"), "campusID" => $this->input->post("campusID")));
                if(!empty($salary_grades)) {
                    $this->form_validation->set_message("unique_salary_grades", "%s already exists");
                    return FALSE;
                }
