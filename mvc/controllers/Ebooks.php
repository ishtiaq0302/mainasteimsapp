...
*/
	...
	public function index() {
		...
		$ebooks = $this->ebooks_m->get_order_by_ebooks_with_authority($classes,$campusID);
	...
	public function edit() {
		...
		if((int)$ebooksID) {
			...
			$this->data['campusID'] = $this->data['ebooks']->campusID;
			$this->data['classesID'] = $this->data['ebooks']->classesID;

			if(!empty($this->data['ebooks'])) {
