...
class Productcategory extends Admin_Controller {
    ...
    */
    ...
    function __construct() {
        ...
        $this->load->model("productcategorytype_m");
    ...
    public function index() {
        ...
        $this->data['campusID']=$campusID;
         $this->data['productcategorystype'] = pluck($this->productcategorytype_m->get_productcategorytype(), 'productcategorytype', 'productcategorytypeID');
        $this->data['productcategorys'] = $this->productcategory_m->get_order_by_productcategory(array('campusID'=>$campusID));
    ...
    public function add() {
        $this->data['productcategorystype'] = $this->productcategorytype_m->get_productcategorytype();
        if($_POST) {
            $rules = $this->rules();
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $array = array(
                    ...
                    "productcategorytypeID" => $this->input->post("productcategorytypeID"),
                    /*"productcategorytype" => $this->input->post("productcategorytype"),*/
                ...
                redirect(base_url("productcategory/index/".$array['campusID']));
            }
        } else {
            $this->data["subview"] = "productcategory/add";
            $this->load->view('_layout_main', $this->data);
    ...
    public function edit() {
        ...
        if((int)$id) {
            ...
            $this->data['productcategorys'] = $this->data['productcategory'];

            $this->data['campusID']=$this->data['productcategory']->campusID;
            $this->data['productcategorystype'] = $this->productcategorytype_m->get_productcategorytype();
    ...
    public function unique_productcategoryname() {
        $id = htmlentities(escapeString($this->uri->segment(3)));
        if((int)$id) {
            $product = $this->productcategory_m->get_order_by_productcategory(array("productcategoryname" => $this->input->post("productcategoryname"), "productcategoryID !=" => $id, "campusID" => $this->input->post("campusID")));
            if(!empty($product)) {
            ...
            $product = $this->productcategory_m->get_order_by_productcategory(array("productcategoryname" => $this->input->post("productcategoryname"), "campusID" => $this->input->post("campusID")));
            if(!empty($product)) {
                $this->form_validation->set_message("unique_productcategoryname", "The %s is already exists.");
                return FALSE;
            }
