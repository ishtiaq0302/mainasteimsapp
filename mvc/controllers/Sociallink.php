...
class Sociallink extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        ...
        if((int)$id) {
            $sociallinks = $this->sociallink_m->get_order_by_sociallink(array('usertypeID' => $id,'campusID' => $campusID));
        } else {
            $sociallinks = $this->sociallink_m->get_order_by_sociallink(array('campusID'=>$campusID));
        }
    ...
    public function edit() {
        ...
        if((int)$id) {
            ...
            $this->data['campusID']=$this->data['sociallink']->campusID;
            $this->data['set']=$this->data['sociallink']->usertypeID;
    ...
    public function gerUser() {
        $userroleIDs = $this->input->post('userroleID');

        $campusID = explode('/', $userroleIDs, 2)[1];
        $userroleID = strtok($userroleIDs, '/');
        ...
        if((int)$userroleID) {
            ...
            if($userroleID == 1) {
                ...
                $students = $this->student_m->get_order_by_student(array('campusID' => $campusID));
                if(!empty($students)) {
                    foreach ($students as $student) {
                        $userArray[$student->studentID] = $student->name;
                    }
                ...
                $users = $this->user_m->get_order_by_user(array('usertypeID' => $userroleID,'campusID' => $campusID));
                if(!empty($users)) {
                    foreach ($users as $user) {
                        $userArray[$user->userID] = $user->name;
                    }
