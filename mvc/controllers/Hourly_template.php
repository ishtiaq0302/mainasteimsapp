...
class Hourly_template extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        ...
        $this->data['hourly_templates'] = $this->hourly_template_m->get_order_by_hourly_template(array('campusID'=>$campusID));
    ...
    public function edit() {
        ...
        if((int)$id) {
            ...
            $this->data['campusID']=$this->data['hourly_template']->campusID;
    ...
    public function unique_hourly_grades() {
        $id = htmlentities(escapeString($this->uri->segment(3)));
        if((int) $id) {
            $hourly_grades = $this->hourly_template_m->get_single_hourly_template(array('hourly_grades' => $this->input->post("hourly_grades"), 'hourly_templateID !=' => $id, "campusID" => $this->input->post("campusID")));
            if(!empty($hourly_grades)) {
                $this->form_validation->set_message("unique_hourly_grades", "%s already exists");
                return FALSE;
            }
            return TRUE;
        } else {
            $hourly_grades = $this->hourly_template_m->get_single_hourly_template(array('hourly_grades' => $this->input->post('hourly_grades'), "campusID" => $this->input->post("campusID")));
            if(!empty($hourly_grades)) {
                $this->form_validation->set_message("unique_hourly_grades", "%s already exists");
                return FALSE;
            }
