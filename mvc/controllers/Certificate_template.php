...
class Certificate_template extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        ...
        $this->data['certificate_templates'] = $this->certificate_template_m->get_order_by_certificate_template(array('campusID'=>$campusID));
    ...
    public function add() {
        ...
        if($_POST) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                redirect(base_url("certificate_template/index/".$array['campusID']));
            }
        } else {
            $this->data["subview"] = "/certificate_template/add";
            $this->load->view('_layout_main', $this->data);
    ...
    public function edit() {
        ...
        if((int)$id) {
            ...
            $this->data['campusID']=$this->data['certificate_template']->campusID;
