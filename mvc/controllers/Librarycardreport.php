...
*/
        ...
        if(permissionChecker('librarycardreport')) {
            if($_POST) {
                ...
                if ($this->form_validation->run() == FALSE) {
                    ...
                    $single_classes     = $this->classes_m->get_single_classes(array('classesID'=>$this->data['classesID']));
                    $this->data["siteinfos"] = $this->site_m->get_site_($single_classes->campusID);
    ...
    public function pdf() {
        if(permissionChecker('librarycardreport')) {
            ...
            $single_classes     = $this->classes_m->get_single_classes(array('classesID'=>$classesID));
            $this->data["siteinfos"] = $this->site_m->get_site_($single_classes->campusID);
