...
$('#dob').datepicker().on('changeDate', function(selected){
        startDate = new Date(selected.date.valueOf());
        $('#jod').datepicker('setStartDate', startDate);
    });  
$('#jod').datepicker().on('changeDate', function(selected){
        startDate = new Date(selected.date.valueOf());
        $('#dob').datepicker('setEndDate', startDate);
    });
});
