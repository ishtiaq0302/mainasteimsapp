                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <?php foreach($activitiescategories as $category) { ?>
                                    ...
                                    <a href="<?=base_url('activities/add/'.$category->activitiescategoryID.'/'.$category->campusID)?>" class="col-sm-1 btn btn-app bg-<?=$colors[$randIndex];?>">
...
$('#campusID').change(function(event) {
    ...
    window.location.href = "<?=base_url('activities/index/')?>"+campusID;
});
</script>
