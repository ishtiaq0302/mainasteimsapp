                            ...
                            <div id="all" class="tab-pane active">
                                <div id="hide-table">
                                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                                        ...
                                        <tbody>
                                            <?php if(!empty($examschedules)) {$i = 1; foreach($examschedules as $examschedule) { ?>
                                                <tr>
                                    ...
                                    <div id="<?=$section->sectionID?>" class="tab-pane">
                                        ...
                                        <div id="hide-table">
                                            <table class="table table-striped table-bordered table-hover dataTable no-footer">
                                                ...
                                                <tbody>
                                                    <?php if(!empty($allsection[$section->section])) {$i = 1; foreach($allsection[$section->section] as $examschedule) { ?>
                                                        <tr>
                                                            <td data-title="<?=$this->lang->line('slno')?>">
                                                                <?php echo $i; ?>
                                                            </td>
