                    ...
                    <div class="row">
                        <div id="hide-table">
                            <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                                ...
                                <tbody>
                                    <?php if(!empty($issues)) {$i = 1; foreach($issues as $issue) { 
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td data-title="<?=$this->lang->line('action')?>">
                                                <?php
                                                    echo btn_view('issue/view/'.$issue->issueID.'/'.$campusID, $this->lang->line('view')).' ';
...
$('#campusID').change(function(event) {
    ...
    var libID = "<?=$libID?>";
    window.location.href = "<?=base_url('issue/index/')?>"+libID+"/"+campusID;
});
</script>