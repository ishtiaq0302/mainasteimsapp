        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    ...
                    <?php } else { ?>
                        <li><a href="<?=base_url("issue/index/$lmember->lID/$campusID")?>"><?=$this->lang->line('menu_issue')?></a></li>
                    <?php } ?>
                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('issue_classes')?></b> <a class="pull-right"><?=!empty($classes) ? $classes->classes : ''?></a>
                            </li>
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('issue_section')?></b> <a class="pull-right"><?=!empty($section) ? $section->section : ''?></a>
                            </li>
                        </ul>
                    </div>
                </div>
