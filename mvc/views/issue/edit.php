...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?=base_url("issue/index/$set/$campusID")?>"><?=$this->lang->line('menu_issue')?></a></li>
...
function getInfoByCampus(campusID)
{
    $.ajax({
        async: false,
        type: 'POST',
        url: "<?=base_url('universalfunction/bookcall')?>",
        data: "id=" + campusID,
        dataType: "html",
        success: function(data) {
            $('#book').html(data);
            $('#book option[value="<?=$bookID?>"]').attr('selected','selected');
        }
    });
}       
