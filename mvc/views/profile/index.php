                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <?php } elseif($profile->usertypeID == 3) { ?>
                                ...
                                <li class="list-group-item" style="background-color: #FFF">
                                    <b><?=$this->lang->line('profile_classes')?></b> <a class="pull-right"><?=!empty($class) ? $class->classes : ''?></a>
                                </li>
                                <li class="list-group-item" style="background-color: #FFF">
                                    <b><?=$this->lang->line('profile_section')?></b> <a class="pull-right"><?=!empty($sectionn) ? $sectionn->section : ''?></a>
                                </li>
                            <?php } else { ?>
                                <li class="list-group-item" style="background-color: #FFF">
                                ...
                                <?php if($profile->usertypeID == 3) { ?>
                                    <div class="row">
                                        <div class="profile-view-tab">
                                            <p><span><?=$this->lang->line("profile_studentgroup")?> </span>: <?=!empty($group) ? $group->group : '' ?></p>
                                        </div>
                                        <div class="profile-view-tab">
                                            <p><span><?=$this->lang->line("profile_optionalsubject")?> </span>: <?=!empty($optionalsubject) ? $optionalsubject->subject : ''?></p>
                                        </div>
                                        <div class="profile-view-tab">
                                ...
                                <div class="tab-pane" id="payment">
                                    <div id="hide-table">
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <?php $paymentTotal = 0; if(!empty($make_payments)) { $i = 1; foreach($make_payments as $make_payment) { ?>
                                                    <tr>
                            ...
                            <div class="tab-pane" id="invoice">
                                <div id="hide-table">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php $totalInvoice = 0; $totalDiscount = 0; $totalPaid = 0; $totalWeaver = 0; $totalDue = 0; $totalFine = 0; if(!empty($invoices)) { $i = 1; foreach ($invoices as $invoice) { //dump($invoice); ?>
                                                <tr>
                                                    <td data-title="<?=$this->lang->line('slno')?>">
                                                        <?php echo $i; ?>
                                                    </td>
                            ...
                            <div class="tab-pane" id="children">
                                <div id="hide-table">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php if(!empty($childrens)) {$i = 1; foreach($childrens as $children) { ?>
                                                <tr>
                                                    <td data-title="<?=$this->lang->line('slno')?>">
                                                        <?=$i?>  
                                                    </td>
