            ...
            <div class="col-sm-12">
                ...
                <div id="hide-table">
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        ...
                        <tbody>
                            <?php if(!empty($systemadmins)) {$i = 1; foreach($systemadmins as $systemadmin) { 
                                if($systemadmin->systemadminID != 1 && $this->session->userdata('loginuserID') != $systemadmin->systemadminID) { ?>
                                <tr>
                                    ...
                                    <?php if(permissionChecker('systemadmin_edit') || permissionChecker('systemadmin_delete') || permissionChecker('systemadmin_view')) { ?>
                                        <td data-title="<?=$this->lang->line('action')?>">
                                            <?php echo btn_view('systemadmin/view/'.$systemadmin->systemadminID.'/'.$systemadmin->campusID, $this->lang->line('view')) ?>
...
$('#campusID').change(function(event) {
    ...
    window.location.href = "<?=base_url('systemadmin/index/')?>"+campusID;
});
</script>
