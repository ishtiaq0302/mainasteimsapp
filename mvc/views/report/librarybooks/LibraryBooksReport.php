<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            $pdf_preview_uri = base_url('librarybooksreport/pdf/'.$campusID.'/'.$bookname.'/'.$subjectcode.'/'.$rackNo.'/'.$status);
            $xml_preview_uri = base_url('librarybooksreport/xlsx/'.$campusID.'/'.$bookname.'/'.$subjectcode.'/'.$rackNo.'/'.$status);
