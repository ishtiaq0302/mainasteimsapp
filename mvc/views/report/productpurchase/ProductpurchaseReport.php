<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            if($fromdate != '' && $todate != '') {
                $generatepdfurl = base_url("productpurchasereport/pdf/".$campusID."/".$productsupplierID."/".$productwarehouseID."/".$reference_no."/".$statusID."/".strtotime($fromdate)."/".strtotime($todate));
                $generatexmlurl = base_url("productpurchasereport/xlsx/".$campusID."/".$productsupplierID."/".$productwarehouseID."/".$reference_no."/".$statusID."/".strtotime($fromdate)."/".strtotime($todate));
            } else {
                $generatepdfurl = base_url("productpurchasereport/pdf/".$campusID."/".$productsupplierID."/".$productwarehouseID."/".$reference_no."/".$statusID);
                $generatexmlurl = base_url("productpurchasereport/xlsx/".$campusID."/".$productsupplierID."/".$productwarehouseID."/".$reference_no."/".$statusID);
            }
