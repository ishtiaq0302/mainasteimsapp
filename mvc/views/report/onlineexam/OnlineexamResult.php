<?php if(!empty($onlineExamUserStatus)) { ?>
<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            $onlineExamUserStatusID = !empty($onlineExamUserStatus) ? $onlineExamUserStatus->onlineExamUserStatus : 0; 
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <span class="text-blue">
                                                <?=$this->lang->line('onlineexamreport_exam')?> : <?=!empty($onlineexam) ? $onlineexam->name : ''?>
                                            </span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <?php if($onlineexam->subjectID > 0) { ?>
                                                <tr>
                                                    ...
                                                    <td><?=!empty($subject) ? $subject->subject : ''?></td>
                                                </tr>
                                            <?php } ?>
                                            <tr>
                                                <td>
...
<script type="text/javascript">
    ...
    $('#send_pdf').click(function() {
        var field = {
            ...
            'subject'   : $('#subject').val(), 
            'message'   : $('#message').val(),
            'id'        : "<?=!empty($onlineExamUserStatus) ? $onlineExamUserStatus->onlineExamUserStatus : 0;?>",
        };
