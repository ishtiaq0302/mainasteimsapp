        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-12">
                            <h5 class="pull-left"><?="Teachers"?> : </h5>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    foreach($teachers as $teacher) {
                                        $userleaveapplications = isset($leaveapplications[$teacher->teacherID]) ? $leaveapplications[$teacher->teacherID] : [];
                                        ...
                                        if((in_array($attendancedate, $userleaveapplications) && ($typeSortForm != 'LA'))) {
                                            ...
                                            continue;
                                        } elseif(isset($attendances[$teacher->teacherID])) {
                    //                         echo "<pre>";
                    // print_r($attendances[$teacher->teacherID]);
                    // echo "</pre>";
                                            $attendanceDay = $attendances[$teacher->teacherID]->$day;
                    ...
                    <?php } else { ?>
                        <div class="callout callout-danger">
                            <p><b class="text-info"><?="Don't have any Teachers"?></b></p>
                        </div>
                    <?php } ?>
                </div>
