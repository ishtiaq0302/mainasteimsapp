...
<div class="box">
    ...
    <div id="printablediv">
        ...
        <div class="box-body" style="margin-bottom: 50px;">
            <div class="row">
                <div class="col-sm-12">
                <?php if(!empty($studentLists)) { foreach($studentLists as $student) { ?>
                    <div class="mainterminalreport">
                        ...
                        <div class="terminal-infos">
                            ...
                            <div class="student-profile">
                                ...
                                <p><?=$this->lang->line('terminalreport_position_in_class')?> :  <b><?=!empty($studentPosition['studentClassPositionArray']) ? addOrdinalNumberSuffix((int)array_search($student->srstudentID, array_keys($studentPosition['studentClassPositionArray'])) + 1) : ''?></b></p>
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <?php if(!empty($markpercentages)) { foreach($markpercentages as $markpercentage) { ?>
                                ...
                                <tbody>
                                    <?php if(!empty($subjects)) { foreach($subjects as $subject) { ?> 
                                        <?php if(isset($studentPosition[$student->srstudentID]['subjectMark'][$subject->subjectID])) { ?>
                                            <tr>
                                                ...
                                                if(!empty($grades)) { foreach($grades as $grade) { 
                                    ...
                                    <tr>
                                        <td colspan="<?=$col?>"><?=$this->lang->line('terminalreport_interpretation')?> :
                                            <b>
                                                <?php if(!empty($grades)) { $i = 1; foreach($grades as $grade) { 
                                                    if(count($grades) == $i) {
