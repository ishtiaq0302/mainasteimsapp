                        ...
                        <div class="terminal-infos">
                            ...
                            <div class="mandatory_subjects">
                                <table>
                                    ...
                                    <?php $mandatory_column = 0; if(!empty($subjects)) { foreach($subjects as $subject) { if($subject->type == 1) { ?>
                                    <tr>
                            ...
                            <div class="optinal_subjects">
                                <?php if($optionalSubjectStatus) { ?>
                                    <table>
                                        ...
                                        <?php $optional_column = 0; if(!empty($subjects)) { foreach($subjects as $subject) { if($subject->type != 1) { ?>
                                        <tr>
                                            <td><?=$subject->subject_code?></td>
                                            <td><?=substr($subject->subject,0,3)?></td>
                                            <td><?=$subject->subject?></td>
                        ...
                        <div class="terminal-contents meritstagereporttable">
                            <table>
                                <thead>
                                    ...
                                    <tr>
                                        <?php if(!empty($subjects)) { foreach($subjects as $subject) { if($subject->type == 1) { ?>
                                ...
                                <tbody>
                                <?php $i=0; if(!empty($studentPosition['studentClassPositionArray'])) { foreach($studentPosition['studentClassPositionArray'] as $studentID => $student) {
