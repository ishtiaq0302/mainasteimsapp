<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            $generatepdfurl = base_url("salaryreport/pdf/".$campusID."/".$usertypeID."/".$userID."/".$fromdate."/".$todate."/".$month);
            $generatexmlurl = base_url("salaryreport/xlsx/".$campusID."/".$usertypeID."/".$userID."/".$fromdate."/".$todate."/".$month);
