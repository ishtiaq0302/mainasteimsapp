    ...
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            ...
            if($siteinfos->attendance == 'subject') {
                $pdfurl = 'attendanceoverviewreport/pdf/'.$campusID.'/'.$usertype.'/'.$classesID.'/'.$sectionID.'/'.$subjectID.'/'.$userID.'/'.strtotime($monthID);
                $xmlurl = 'attendanceoverviewreport/xlsx/'.$campusID.'/'.$usertype.'/'.$classesID.'/'.$sectionID.'/'.$subjectID.'/'.$userID.'/'.strtotime($monthID);
            } else {
                $pdfurl = 'attendanceoverviewreport/pdf/'.$campusID.'/'.$usertype.'/'.$classesID.'/'.$sectionID.'/'.$userID.'/'.strtotime($monthID);
                $xmlurl = 'attendanceoverviewreport/xlsx/'.$campusID.'/'.$usertype.'/'.$classesID.'/'.$sectionID.'/'.$userID.'/'.strtotime($monthID);
            }
