<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            ...
            $pdf_preview_uri = base_url('balancefeesreport/pdf/'.$campusID.'/'.$classesID.'/'.$sectionID.'/'.$studentID);
            $xml_preview_uri = base_url('balancefeesreport/xlsx/'.$campusID.'/'.$classesID.'/'.$sectionID.'/'.$studentID);
