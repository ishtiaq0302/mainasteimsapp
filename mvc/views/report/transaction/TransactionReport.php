<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            $generatepdfurl = base_url("transactionreport/pdf/".$campusID."/".strtotime($fromdate)."/".strtotime($todate).'/1');
            $generatexmlurl = base_url("transactionreport/xlsx/".$campusID."/".strtotime($fromdate)."/".strtotime($todate).'/1');
                                    ...
                                    <table id="example1" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $totalweaver = 0;
                                                $totalfine   = 0;
                                                if(!empty($get_payments)) { $i=1; foreach($get_payments as $get_payment) { 
                            ...
                            <div id="expense_details" class="tab-pane">
                                <div id="hide-table">
                                    <table id="example1" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php $totalexpense = 0; $i=1; if(!empty($expenses)) { foreach($expenses as $expense) {?>
                                                <tr>
                                                    <td data-title="<?=$this->lang->line('slno')?>"><?=$i?></td>
                            ...
                            <div id="salary_details" class="tab-pane">
                                <div id="hide-table">
                                    <table id="example1" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php $totalSalary = 0; $i=1; if(!empty($salarys)) { foreach($salarys as $salary) {?>
                                                <tr>
                                                    <td data-title="<?=$this->lang->line('slno')?>"><?=$i?></td>
