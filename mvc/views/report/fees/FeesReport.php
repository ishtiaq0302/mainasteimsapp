<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            if($fromdate !='' && $todate !='') {
                $pdf_preview_uri = base_url('feesreport/pdf/'.$campusID.'/'.$classesID.'/'.$sectionID.'/'.$studentID.'/'.$feetypeID.'/'.strtotime($fromdate).'/'.strtotime($todate));
            } else {
                $pdf_preview_uri = base_url('feesreport/pdf/'.$campusID.'/'.$classesID.'/'.$sectionID.'/'.$studentID.'/'.$feetypeID);
            }

            if($fromdate !='' && $todate !='') {
                $xml_preview_uri = base_url('feesreport/xlsx/'.$campusID.'/'.$classesID.'/'.$sectionID.'/'.$studentID.'/'.$feetypeID.'/'.strtotime($fromdate).'/'.strtotime($todate));
            } else {
                $xml_preview_uri = base_url('feesreport/xlsx/'.$campusID.'/'.$classesID.'/'.$sectionID.'/'.$studentID.'/'.$feetypeID);
            }
