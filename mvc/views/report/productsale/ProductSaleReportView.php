...
getInfoByCampusReport(<?=$this->session->userdata('campus_id');?>);
    function getInfoByCampusReport(campusID)
    { 
        $.ajax({
            async: false,
            type: 'POST',
            url: "<?=base_url('universalreportfunction/classcall')?>",
            data: "id=" + campusID,
            dataType: "html",
            success: function(data) {
                $('#productsaleclassesID').html(data);
            }
        }); 
    }
    ...
    $('#productsalecustomertypeID, #productsaleclassesID').change(function(event) {
        ...
        if(productsalecustomertypeID === '0') {
            ...
            $.ajax({
                ...
                data: {'productsalecustomertypeID' : productsalecustomertypeID, 'productsaleclassesID' : productsaleclassesID, 'campusID' : campusID},
                dataType: "html",
                success: function(data) {
