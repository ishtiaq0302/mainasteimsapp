<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
        if($fromdate != '' || $todate != '' ) {
            $generatepdfurl = base_url("productsalereport/pdf/".$campusID."/".$productsalecustomertypeID."/".$productsaleclassesID."/".$productsalecustomerID."/".$reference_no."/".$statusID."/".strtotime($fromdate)."/".strtotime($todate));
            $generatexmlurl = base_url("productsalereport/xlsx/".$campusID."/".$productsalecustomertypeID."/".$productsaleclassesID."/".$productsalecustomerID."/".$reference_no."/".$statusID."/".strtotime($fromdate)."/".strtotime($todate));
        } else {
            $generatepdfurl = base_url("productsalereport/pdf/".$campusID."/".$productsalecustomertypeID."/".$productsaleclassesID."/".$productsalecustomerID."/".$reference_no."/".$statusID);
            $generatexmlurl = base_url("productsalereport/xlsx/".$campusID."/".$productsalecustomertypeID."/".$productsaleclassesID."/".$productsalecustomerID."/".$reference_no."/".$statusID);
        }
