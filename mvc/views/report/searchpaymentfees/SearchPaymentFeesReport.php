                            ...
                            <!-- <div class="row"> -->
                                ...
                                <div class="col-sm-12">
                                    <table class="table info">
                                        <tr>
                                            <td><b><?=$this->lang->line('searchpaymentfeesreport_invoice_number')?> : </b>INV-G-<?=!empty($globalpayments) ? $globalpayments[0]->globalpaymentID : ''?></td>
                                            <td><b><?=$this->lang->line('searchpaymentfeesreport_clearance')?> : </b><?=!empty($globalpayments) ? $globalpayments[0]->clearancetype : '' ?></td>
                                            <td><b><?=$this->lang->line('searchpaymentfeesreport_date')?> : </b> <?=!empty($globalpayments) ? date('d M Y', strtotime($globalpayments[0]->paymentdate)) : '' ?></td>
                                        </tr>
                                            <tr>
                                                <td><b><?=$this->lang->line('searchpaymentfeesreport_name')?> : </b> <?=!empty($studentinfo) ? $studentinfo->srname : ''?></td>

                                                <td><b><?=$this->lang->line('searchpaymentfeesreport_classes')?> : </b> <?=!empty($studentinfo) ? $studentinfo->srclasses  : ''?>, <b><?=$this->lang->line('searchpaymentfeesreport_roll')?> : </b> <?=!empty($studentinfo) ? $studentinfo->srroll : ''?>, <b><?=$this->lang->line('searchpaymentfeesreport_section')?> : </b><?=!empty($studentinfo) ? $studentinfo->srsection  : ''?></td>
                                                <td><b><?=$this->lang->line('searchpaymentfeesreport_group')?> : </b><?=!empty($groups[$studentinfo->srstudentgroupID]) ? $groups[$studentinfo->srstudentgroupID] : '' ?></td>
                                            </tr>
                                        <tr>
                                ...
                                <div class="col-sm-12" style="margin-top:0px">
                                    <table id="example1" class="table">
                                        ...
                                        if(!empty($globalpayments)) { foreach($globalpayments as $payment) { ?>
                                            <tr>
