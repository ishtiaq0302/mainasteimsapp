            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <?php if(!empty($exams)) { foreach($exams as $examID => $exam) { ?>
                    ...
                    <tr>
                        <?php if(!empty($exams)) { foreach($exams as $examID => $exam) {
                            if(!empty($markpercentages)) { foreach($markpercentages as $markpercentage) { ?>
                ...
                if(!empty($mandatorySubjects)) { foreach($mandatorySubjects  as $mandatorySubject) {
                    $totalSubjectMark = 0; ?>
                    <tr>
