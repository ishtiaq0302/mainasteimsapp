<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            if($fromdate != '' && $todate !='' )  {
                $pdf_preview_uri = base_url('accountledgerreport/pdf/'.$campusID.'/'.$schoolyearID.'/'.strtotime($fromdate).'/'.strtotime($todate));
            } else {
                $pdf_preview_uri = base_url('accountledgerreport/pdf/'.$campusID.'/'.$schoolyearID);
            } 
