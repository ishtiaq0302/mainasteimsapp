<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            ...
            $pdf_preview_uri = base_url('examschedulereport/pdf/'.$campusID.'/'.$examID.'/'.$classesID.'/'.$sectionID);
            $xml_preview_uri = base_url('examschedulereport/xlsx/'.$campusID.'/'.$examID.'/'.$classesID.'/'.$sectionID);
    ...
    <div id="printablediv">
        ...
        <div class="box-body" style="margin-bottom: 50px;">
            <div class="row">
                ...
                <?php } ?>
                <div class="col-sm-12">
                    <?php if(!empty($examschedule_reports)) {?>
