<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            $pdf_preview_uri = base_url('studentfinereport/pdf/'.$campusID.'/'.strtotime($fromdate).'/'.strtotime($todate));
            $xml_preview_uri = base_url('studentfinereport/xlsx/'.$campusID.'/'.strtotime($fromdate).'/'.strtotime($todate));
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php $total_fine = 0; $i=0; foreach($studentfines as $studentfine) { $i++;
                                            if($campusID>0)
                                            {
                                                if($campusID != $studentfine->campusID)
                                                {
                                                    continue;
                                                }
                                            }
