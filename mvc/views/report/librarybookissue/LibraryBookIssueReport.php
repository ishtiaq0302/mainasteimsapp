<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            if($lID == '') {
                $pdf_preview_uri = base_url('librarybookissuereport/pdf/'.$campusID.'/'.$classesID.'/'.$sectionID.'/'.$studentID.'/'.$typeID.'/'.$fromdate.'/'.$todate);
                $xml_preview_uri = base_url('librarybookissuereport/xlsx/'.$campusID.'/'.$classesID.'/'.$sectionID.'/'.$studentID.'/'.$typeID.'/'.$fromdate.'/'.$todate);
            } else {
                $pdf_preview_uri = base_url('librarybookissuereport/pdf/'.$campusID.'/'.$classesID.'/'.$sectionID.'/'.$studentID.'/'.$typeID.'/'.$fromdate.'/'.$todate.'/'.$lID);
                $xml_preview_uri = base_url('librarybookissuereport/xlsx/'.$campusID.'/'.$classesID.'/'.$sectionID.'/'.$studentID.'/'.$typeID.'/'.$fromdate.'/'.$todate.'/'.$lID);
            }
    ...
    <!-- form start -->
        <div class="box-body" style="margin-bottom: 50px;">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <?php if(!empty($getLibrarybookissueReports)) { ?>
                    <div id="hide-table">
