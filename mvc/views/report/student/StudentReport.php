<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            ...
            $pdf_preview_uri = base_url('studentreport/pdf/'.$campusID.'/'.$reportfor.'/'.$bloodID.'/'.$country.'/'.$transport.'/'.$hostel.'/'.$gender.'/'.$birthdaydatetime.'/'.$classesID.'/'.$sectionID);
            $xml_preview_uri = base_url('studentreport/xlsx/'.$campusID.'/'.$reportfor.'/'.$bloodID.'/'.$country.'/'.$transport.'/'.$hostel.'/'.$gender.'/'.$birthdaydatetime.'/'.$classesID.'/'.$sectionID);
