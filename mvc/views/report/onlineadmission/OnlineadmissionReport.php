<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            $pdf_preview_uri = base_url('onlineadmissionreport/pdf/'.$campusID.'/'.$schoolyearID.'/'.$classesID.'/'.$status.'/'.$phone.'/'.$admissionID);
