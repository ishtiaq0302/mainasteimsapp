    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb">
                ...
                <li><a href="<?=base_url("sattendance/index/$set/$campusID")?>"><?=$this->lang->line('menu_sattendance')?></a></li>
                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('attendance_classes')?></b> <a class="pull-right"><?=!empty($classes) ? $classes->classes : ''?></a>
                            </li>
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('attendance_section')?></b> <a class="pull-right"><?=!empty($section) ? $section->section : ''?></a>
                            </li>
                        </ul>
                    </div>
                </div>
