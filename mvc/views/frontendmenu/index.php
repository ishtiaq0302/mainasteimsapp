	        			...
	        			<div class="form-group">
							...
							<div class="col-sm-3">
								<select class="form-control top-meu-select-property" id="topbar-menu-select-property">
									<?php if(!empty($fmenus)) foreach ($fmenus as $fmenu) { ?>
        	...
        	<div class="row">
				...
				<div class="col-sm-8">
					<div id="menu-management">
						<div id="create-new-menu-box" <?=!empty($fmenus) ? 'style="display: none"' : '' ?>>
								...
								<div class="menu-settings">
									...
									<fieldset class="menu-settings-list">
									    ...
									    <div class="menu-settings-input">
									        <input <?=!empty($activefmenu) ? ($activefmenu->topbar == 1) ? ' checked="checked" ' : '' : ''?> type="checkbox"  name="menu-locations_top" id="locations-top" value="1">
									        <label for="locations-top"><?=$this->lang->line('frontendmenu_top_menu')?></label>
									    </div>
									    <div class="menu-settings-input">
									        <input <?=!empty($activefmenu) ? ($activefmenu->social == 1) ? ' checked="checked" ' : '' : ''?>  type="checkbox" name="menu_locations_social" id="locations-social" value="1">
