...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?=base_url("asset_assignment/index/$campusID")?>"><?=$this->lang->line('menu_asset_assignment')?></a></li>
...
function getInfoByCampus(campusID)
{
    $.ajax({
        async: false,
        type: 'POST',
        url: "<?=base_url('universalfunction/assetlocationcall')?>",
        data: "id=" + campusID,
        dataType: "html",
        success: function(data) {
            $('#asset_locationID').html(data);
            $('#asset_locationID option[value="<?=$asset_locationID?>"]').attr('selected','selected');
        }
    });
