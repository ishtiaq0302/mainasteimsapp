                                ...
                                <div class="row">
                                    <div class="col-sm-10">
                                        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                            ...
                                            <?php
                                                if(form_error('bulk_api_key'))
                                                    echo "<div class='form-group has-error' >";
                                                else
                                                    echo "<div class='form-group' >";
                                            ?>
                                                <label for="bulk_api_key" class="col-sm-2 control-label">
                                                    <?=$this->lang->line("smssettings_api_key")?> <span class="text-red">*</span>
                                                </label>
                                                <div class="col-sm-6">
                                                  <?php if (empty($set_bulk)): ?>
                                                    <input type="text" class="form-control" id="bulk_api_key" name="bulk_api_key" value="<?=set_value('bulk_api_key')?>" >
                                                  <?php else: ?>

                                                    <!-- Old Input changes on value -->
                                                  <?php /*  <input type="text" class="form-control" id="bulk_api_key" name="bulk_api_key" value="<?=set_value('bulk_api_key', $set_bulk['bulk_api_key'])?>" > */ ?>
                                                    
                                                    <input type="text" class="form-control" id="bulk_api_key" name="bulk_api_key" value="<?=set_value('bulk_api_key', $set_bulk['bulk_api_key'])?>" >
                                                  <?php endif; ?>
                                                </div>
                                                <span class="col-sm-4 control-label">
                                                    <?php echo form_error('bulk_api_key'); ?>
                                                </span>
                                            </div>

                                            <?php
                                                if(form_error('bulk_sender'))
                                                    echo "<div class='form-group has-error' >";
                                                else
                                                    echo "<div class='form-group' >";
                                            ?>
                                                <label for="bulk_sender" class="col-sm-2 control-label">
                                                    <?=$this->lang->line("smssettings_sender")?> <span class="text-red">*</span>
                                                </label>
                                                <div class="col-sm-6">
                                                  <?php if (empty($set_bulk)): ?>
                                                    <input type="text" class="form-control" id="bulk_sender" name="bulk_sender" value="<?=set_value('bulk_sender')?>" >
                                                  <?php else: ?>
                                                    <!-- Old Input changes on value -->
                                                  <?php /*  <input type="text" class="form-control" id="bulk_sender" name="bulk_sender" value="<?=set_value('bulk_sender', $set_bulk['bulk_sender'])?>" > */ ?>

                                                    <input type="text" class="form-control" id="bulk_sender" name="bulk_sender" value="<?=set_value('bulk_sender', $set_bulk['bulk_senderID'])?>" >
                                                  <?php endif; ?>
                                                </div>
                                                <span class="col-sm-4 control-label">
                                                    <?php echo form_error('bulk_sender'); ?>
                                                </span>
                                            </div>
