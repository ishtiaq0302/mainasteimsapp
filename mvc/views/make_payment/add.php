    ...
    <div class="col-sm-3">
        <div class="box">
            ...
            <div class="box-body box-profile">
                ...
                <p class="text-muted text-center"><?=$campus->name?></p>
        ...
        <div class="box">
            <div class="box-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?=base_url("make_payment/index/$campusID/$usertype->usertypeID")?>"><?=$this->lang->line('menu_make_payment')?></a></li>
            ...
            <div class="box-body">
                <div id="hide-table">
                    <table id="example1" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if(!empty($make_payments)) { $i = 1; foreach($make_payments as $make_payment) { ?>
                                <tr>
                                    ...
                                    <?php if(permissionChecker('make_payment')) { ?>
                                        <td data-title="<?=$this->lang->line('action')?>">
                                            <a href="<?=base_url("make_payment/view/$make_payment->make_paymentID/$campusID")?>" class="btn btn-xs btn-success" data-placement="top" data-toggle="tooltip" data-original-title="<?=$this->lang->line('view')?>"><i class='fa fa-check-square-o'></i></a>
                                            <?php if(($siteinfos->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) { ?>
                                                <a href="<?=base_url("make_payment/delete/$make_payment->make_paymentID/$campusID")?>" class="btn btn-xs btn-danger" data-placement="top" data-toggle="tooltip" data-original-title="<?=$this->lang->line('delete')?>"><i class='fa fa fa-trash-o'></i></a>
                                            <?php } ?>
                                        </td>
                                    <?php } ?>
                                </tr>
