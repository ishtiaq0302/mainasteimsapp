                                ...
                                <tr>
                                    ...
                                    <?php if(permissionChecker('make_payment')) { ?>
                                        <td data-title="<?=$this->lang->line('action')?>">
                                            <a href="<?=base_url("make_payment/add/$userID/$user->usertypeID/$campusID")?>" class="btn btn-sm btn-success"><?=$this->lang->line('make_payment_make_payment')?></a>
                                        </td>
                                    <?php } ?>
