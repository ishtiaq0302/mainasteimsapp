...
<div class="box">
    ...
    <?php if(campuses()==1)
    {
        ...
        getCampus($this->session->userdata('campus_id')); 
    } ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                foreach ($productcategorystype as $productcategory) {
                                    $productcategorytypeArray[$productcategory->productcategorytypeID] = $productcategory->productcategorytype;
                                }
                                echo form_dropdown("productcategorytypeID", $productcategorytypeArray, set_value("productcategorytypeID"), "id='productcategorytypeID' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('productcategorytypeID'); ?>
                        </span>
                    </div>
