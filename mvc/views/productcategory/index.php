                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th class="col-sm-2"><?=$this->lang->line('productcategory_type')?></th>
                        ...
                        <tbody>
                            <?php if(!empty($productcategorys)) {$i = 1; foreach($productcategorys as $productcategory) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('productcategory_type')?>">
                        <?=isset($productcategorystype[$productcategory->productcategorytypeID]) ? $productcategorystype[$productcategory->productcategorytypeID] : ''?>
                                    </td>
                                    <?php if(permissionChecker('productcategory_edit') || permissionChecker('productcategory_delete')) { ?>
...
$('#campusID').change(function(event) {
    ...
    window.location.href = "<?=base_url('productcategory/index/')?>"+campusID;
});
</script>