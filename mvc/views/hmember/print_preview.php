            ...
            <div class="areaTop">
                ...
                <div class="studentProfile">
                    ...
                    <div class="singleItem">
                        ...
                        <div class="single_value">: <?=!empty($classes) ? $classes->classes : ''?></div>
                    </div>
                    <div class="singleItem">
                        <div class="single_label"><?=$this->lang->line('hmember_section')?></div>
                        <div class="single_value">: <?=!empty($section) ? $section->section : ''?></div>
                    </div>
                </div>
            </div>
                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="70%"><?=!empty($hostel) ? $hostel->name : 'N/A' ?></td>
                        </tr>
                        <tr>
                            <th width="30%"><?=$this->lang->line("hmember_htype")?></th>
                            <td width="70%"><?=!empty($hostel) ? $hostel->htype : 'N/A' ?></td>
                        </tr>
                        <tr>
                            <th width="30%"><?=$this->lang->line("hmember_class_type")?></th>
                            <td width="70%"><?=!empty($category) ? $category->class_type : 'N/A' ?></td>
                        </tr>
                        <tr>
                            <th width="30%"><?=$this->lang->line("hmember_tfee")?></th>
                            <td width="70%"><?=!empty($hmember) ? $hmember->hbalance : 'N/A' ?></td>
                        </tr>
                        <tr>
                            <th width="30%"><?=$this->lang->line("hmember_hostel_address")?></th>
                            <td width="70%"><?=!empty($hostel) ? $hostel->address : 'N/A' ?></td>
                        </tr>
                        <tr>
                            <th width="30%"><?=$this->lang->line("hmember_joindate")?></th>
                            <td width="70%"><?php if(!empty($hmember)) { if($hmember->hjoindate) { echo date("d M Y", strtotime($hmember->hjoindate)); } } else { echo 'N/A'; }  ?></td>
                        </tr>
                        <tr>
