        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?=base_url("hmember/index/$set/$campusID")?>"><?=$this->lang->line('panel_title')?></a></li>
                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('hmember_classes')?></b> <a class="pull-right"><?=!empty($class) ? $class->classes : ''?></a>
                            </li>
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('menu_section')?></b> <a class="pull-right"><?=!empty($section) ? $section->section : ''?></a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="active tab-pane" id="profile">
                            <div class="panel-body profile-view-dis">
                                <div class="row">
                                    ...
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("hmember_hname")?> </span>: <?=!empty($hostel) ? $hostel->name : 'N/A' ?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("hmember_htype")?> </span>: <?=!empty($hostel) ? $hostel->htype : 'N/A' ?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("hmember_class_type")?> </span>: <?=!empty($category) ? $category->class_type : 'N/A' ?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("hmember_tfee")?> </span>: <?=!empty($hmember) ? $hmember->hbalance : 'N/A' ?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("hmember_hostel_address")?> </span>: <?=!empty($hostel) ? $hostel->address : 'N/A' ?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("hmember_joindate")?> </span>: <?php if(!empty($hmember)) { if($hmember->hjoindate) { echo date("d M Y", strtotime($hmember->hjoindate)); } } else { echo 'N/A'; } ?></p>
                                    </div>
                                    <div class="profile-view-tab">
