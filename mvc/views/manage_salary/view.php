    ...
    <div class="well">
        <div class="row">
            <div class="col-sm-7">
                ...
                ?>
                <?php if(permissionChecker('manage_salary_edit')) { echo btn_sm_edit('manage_salary/edit/'.$userID."/".$usertypeID."/".$campusID, $this->lang->line('edit')); } ?>
            ...
            <div class="col-sm-5">
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?=base_url("manage_salary/index/$campusID/$usertypeID")?>"><?=$this->lang->line('menu_manage_salary')?></a></li>
            ...
            <div class="col-sm-3">
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        <p class="text-muted text-center"><?=!empty($usertype) ? $usertype->usertype : ''?></p>
