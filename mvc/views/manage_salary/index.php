                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                if($this->session->userdata('campus_id')==0){
                                    $camID = $this->session->userdata('accountCampusID');                                    
                                }else{
                                ...
                                <div class="col-md-4 role" <?php if($this->session->userdata('campus_id')==0){ ?> style="display:none;" <?php } ?>>
                                        ...
                                        <td data-title="<?=$this->lang->line('action')?>">
                                            <?php 
                                                if(in_array($userID, $managesalary)) {
                                                    echo btn_view('manage_salary/view/'.$userID.'/'.$user->usertypeID.'/'.$campusID, $this->lang->line('view'));
                                                    echo btn_edit('manage_salary/edit/'.$userID.'/'.$user->usertypeID.'/'.$campusID, $this->lang->line('edit'));
                                                    echo btn_delete('manage_salary/delete/'.$userID.'/'.$user->usertypeID.'/'.$campusID, $this->lang->line('delete'));
                                                } else {
                                                    echo btn_add('manage_salary/add/'.$userID.'/'.$user->usertypeID.'/'.$campusID, $this->lang->line('add'));
                                                }
                                            ?>
                                        </td>
                                    <?php } ?>
