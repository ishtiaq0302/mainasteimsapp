...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?=base_url("question_bank/index/$campusID")?>"><?=$this->lang->line('menu_question_bank')?></a></li>
...
<?php
    if(!empty($options) || !empty($answers)) {
        if($typeID == 3) {
            $options =  $answers;
        }
        else {
...
?>
            <script type="text/javascript">
                ...
                var optAns = '<?php if(!empty($answers)) { if(in_array($optionKey, $answers)){  echo 'checked="checked"'; } else { echo ''; } }?>';
