...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?=base_url("purchase/index/$campusID")?>"><?=$this->lang->line('menu_purchase')?></a></li>
...
function getInfoByCampus(campusID)
{
    $.ajax({
        async: false,
        type: 'POST',
        url: "<?=base_url('universalfunction/vendorcall')?>",
        data: "id=" + campusID,
        dataType: "html",
    ...
    $.ajax({
        async: false,
        type: 'POST',
        url: "<?=base_url('universalfunction/assetcall')?>",
        data: "id=" + campusID,
        dataType: "html",
        success: function(data) {
            $('#assetID').html(data);
            $('#assetID option[value="<?=$assetID?>"]').attr('selected','selected');
        }
    });
    ...
    $.ajax({
        async: false,
        type: 'POST',
        url: "<?=base_url('universalfunction/usercall')?>",
        data: "id=" + campusID,
        dataType: "html",
        success: function(data) {
            $('#purchased_by').html(data);
            $('#purchased_by option[value="<?=$purchased_by?>"]').attr('selected','selected');
        }
    });
}       
</script>
