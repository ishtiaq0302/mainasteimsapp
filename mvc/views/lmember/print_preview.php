            ...
            <div class="areaBottom">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td width="70%"><?=!empty($lmember) ? $lmember->lID : 'N/A'?></td>
                    </tr>
                    <tr>
                        <td width="30%"><?=$this->lang->line('lmember_libraryFee')?></td>
                        <td width="70%"><?=!empty($lmember) ? $lmember->lbalance : 'N/A'?></td>
                    </tr>
                    <tr>
                        <td width="30%"><?=$this->lang->line('lmember_joinDate')?></td>
                        <td width="70%"><?php if(!empty($lmember)) { if($lmember->ljoindate) { echo date('d M Y',strtotime($lmember->ljoindate)); } } else { echo 'N/A'; } ?></td>
                    </tr>
                    <tr>
