        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?=base_url("lmember/index/$set/$campusID")?>"><?=$this->lang->line('panel_title')?></a></li>
                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('lmember_classes')?></b> <a class="pull-right"><?=!empty($classes) ? $classes->classes : ''?></a>
                            </li>
                            <li class="list-group-item" style="background-color: #FFF">
                        ...
                        <div class="active tab-pane" id="profile">
                            <div class="panel-body profile-view-dis">
                                <div class="row">
                                    ...
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("lmember_lID")?> </span>: <?=!empty($lmember) ? $lmember->lID : 'N/A'?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("lmember_lfee")?> </span>: <?=!empty($lmember) ? $lmember->lbalance : 'N/A'?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("lmember_joindate")?> </span>: <?=!empty($lmember) ? date("d M Y", strtotime($lmember->ljoindate)) : 'N/A'?></p>
                                    </div>
                                    <div class="profile-view-tab">
