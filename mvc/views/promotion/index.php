                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-12 list-group-item list-group-item-warning">
                                ...
                                <?php 
                                    if($campusID==0){
                                        $camID = $this->session->userdata('campus_id');
                                    }else{
                                        $camID = $campusID;                                        
                                    } 
                                ?>
                                <?php getCampusView($camID,3); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                            ...
                                            foreach ($section as $sect) {
                                                $array[$sect->sectionID] = $sect->section;
                                            }
                                            echo form_dropdown("sectionID", $array, set_value("sectionID", $sectionID), "id='sectionID' required='required' class='form-control select2'");
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="jsectionID" class="control-label">
                                            Promotion <?=$this->lang->line("mark_section")?> <span class="text-red">*</span>
                                        </label>

                                        <?php
                                            $array = array("0" => $this->lang->line("mark_select_section"));
                                            foreach ($sections as $sec) {
                                                $array[$sec->sectionID] = $sec->section;
                                            }
                                            echo form_dropdown("jsectionID", $array, set_value("jsectionID"), "id='jsectionID' class='form-control select2'");
                                        ?>
                                    </div>
                                </div>
                        ...
                        <div id="markdiv" class="col-sm-12">
                            ...
                            <div class="col-sm-offset-4 col-sm-4 col-xs-12" style="margin-top: 18px;">
                                <input type="submit" id="promotion_mark" class="btn btn-success col-sm-12 col-xs-12" value="<?=$this->lang->line("add_mark_setting")?>" >
                            </div>
                    </div>
