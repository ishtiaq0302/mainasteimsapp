                ...
                <div id="hide-table">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <?php if(!empty($studentStatus)) {$i = 1; foreach($studentStatus as $studentSummary) { if($promotionType != 'normal') { $student = $studentSummary['info']; } else { $student = $studentSummary;}?>
                                <tr>
