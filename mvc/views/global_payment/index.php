                                ...
                                <table class="table table-striped table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(!empty($single_classes)) { echo $single_classes->classes; } ?>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(!empty($single_section)) { echo $single_section->section; } ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><?=$this->lang->line('global_group')?></td>
                                            <td>
                                                <?php if(!empty($single_group)) { echo $single_group->group; } ?>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="col-sm-9 invoice-table-responsive">
                                <div class="table-responsive">
                                    <table id="" class="table table-striped table-bordered table-hover dataTable no-footer">
                                        ...
                                        <tbody>
                                            <?php $invoice_total = 0; $invoice_weaver = 0; $invoice_fine = 0; $invoice_paid_fine = 0; if(!empty($globalpayments)) { foreach ($globalpayments as $globalpayment) { ?>
                            ...
                            <table class="table table-striped table-bordered" style="margin-top: 10px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="form-control" id="invoicenumber" type="text" name="invoicenumber" value="INV-G-<?=(!empty($globalpayment_max)) ? $globalpayment_max->globalpaymentID+1 : '1'?>" readonly></td>
...
<?php $paymented_status = TRUE; $paymented_invoice_total = 0; $paymented_invoice_weaver = 0; $paymented_invoice_fine = 0; if(!empty($globalpayments)) { foreach ($globalpayments as $globalpayment) { ?>
                    ...
                    <div class="modal-body" >
                        <div class="assign-fee-payment">
                            ...
                            <table class="table info">
                                ...
                                <tr>
                                    <td><b><?=$this->lang->line('global_name')?>: </b><?=!empty($single_student) ? $single_student->srname : ''?> </td>
                                    <td><b><?=$this->lang->line('global_classes')?>: </b><?=!empty($single_classes) ? $single_classes->classes : ''?>, <b><?=$this->lang->line('global_roll')?>: </b><?=!empty($single_student) ? $single_student->srroll : ''?>, <b><?=$this->lang->line('global_section')?>: </b><?=!empty($single_section) ? $single_section->section : ''?></td>
                                    <td><b><?=$this->lang->line('global_group')?>: </b><?=!empty($single_group) ? $single_group->group : ''?></td>
                                </tr>
                            ...
                            <table class="table">
                                <thead>
                                    <?php if(!empty($paymenteds)) { foreach ($paymenteds as $paymented) { ?>
                                ...
                                <tbody>
                                    <?php $paymentedPaidAmount = 0; $paymentedPaidStatus = FALSE; if(!empty($paymenteds)) { foreach ($paymenteds as $paymented) { ?>
                                        <?php if($globalpayment->globalpaymentID == $paymented->globalpaymentID) { ?>
                                    ...
                                    <?php if(!empty($weaverandfines)) { if(!empty($paymenteds)) { foreach ($paymenteds as $paymented) { ?>
                                        <?php if($globalpayment->globalpaymentID == $paymented->globalpaymentID) { ?>
                                    ...
                                    <?php $paymentedFineAmount = 0; $paymentedFineStatus = FALSE; if(!empty($weaverandfines)) { if(!empty($paymenteds)) { foreach ($paymenteds as $paymented) { ?>
                                        <?php if($globalpayment->globalpaymentID == $paymented->globalpaymentID) { ?>
                                    ...
                                    <?php $paymentedWeaverAmount = 0; $paymentedWeaverStatus = FALSE; if(!empty($weaverandfines)) { if(!empty($paymenteds)) { foreach ($paymenteds as $paymented) { ?>
                                        <?php if($globalpayment->globalpaymentID == $paymented->globalpaymentID) { ?>
