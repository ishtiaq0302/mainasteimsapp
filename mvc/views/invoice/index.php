...
<div class="box">
    ...
    <div class="box-body">
            ...
            <div class="col-sm-12">
                ...
                <div id="hide-table">
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        ...
                        <tbody>
                            <?php if(!empty($maininvoices)) {$i = 1; foreach($maininvoices as $maininvoice) { 
      ...
      <td data-title="Gr.No">
                                        GR<?php echo $maininvoice->srroll; ?>
                                    </td>
...
$('#campusID').change(function(event) {
    ...
    window.location.href = "<?=base_url('invoice/index/')?>"+campusID;
});    
</script>
