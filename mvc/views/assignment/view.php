...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?=base_url("assignment/index/".$viewclass.'/'.$campusID)?>"></i> <?=$this->lang->line('menu_assignment')?></a></li>
            <li class="active">
        	...
        	<div class="col-lg-12">
				<div id="hide-table">
	                <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
	                    ...
	                    <tbody>
	                        <?php if(!empty($assignmentanswers)) {$i = 1; foreach($assignmentanswers as $assignmentanswer) { ?>
	                            <tr>
