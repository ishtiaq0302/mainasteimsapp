            ...
            <div class="col-sm-12">
                ...
                <div id="hide-table">
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        ...
                        <tbody>
                            <?php if(!empty($assignments)) {$i = 1; foreach($assignments as $assignment) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('assignment_section')?>">
                                        ...
                                        if($assignment->sectionID == 'false') {
                                            if(!empty($sections)) foreach ($sections as $sectionkey => $section) {
                                                echo $this->lang->line('assignment_section').' '.$section.'<br>';
                                            }
                                        } else {
                                            $dbSections = json_decode($assignment->sectionID);
                                            if(!empty($dbSections)) foreach ($dbSections as $dbSectionkey => $dbSection) {
