            ...
            <div class="col-sm-12">
                <form action="<?=base_url('bulkimport/teacher_bulkimport');?>" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <div class="col-sm-2 col-xs-6 col-md-2">
                            <?php 
                        $getCampus = $this->campus_m->get_campus();
                        ...
                        echo form_dropdown("campusID", $campusArray, set_value("campusID"), "id='campusID' onchange='getInfoByCampus(this.value)'   class='form-control select2'");

                        echo '</div>';
                        echo '<span class="col-sm-3 control-label">';
