        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?=base_url("productsale/index/$campusID")?>"><?=$this->lang->line('panel_title')?></a></li>
                ...
                <div class="col-xs-12">
                    <div class="table-responsive">
                        <table class="table table-bordered product-style">
                            ...
                            <tbody>
                                <?php $subtotal = 0; $totalsubtotal = 0; if(!empty($productsaleitems)) { $i=1; foreach ($productsaleitems as $productsaleitem) { $subtotal = ($productsaleitem->productsaleunitprice * $productsaleitem->productsalequantity); $totalsubtotal += $subtotal; ?>
                                    <tr>
