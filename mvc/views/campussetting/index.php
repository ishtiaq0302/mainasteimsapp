                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('sname') ? 'has-error' : ''?>" >
                            <div class="col-sm-12">
                                ...
                                <input type="text" class="form-control" id="sname" name="sname" value="<?=set_value('sname', $campussetting->site_title)?>" />
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('phone') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone" value="<?=set_value('phone', $campussetting->phone)?>" >
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('email') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                ...
                                <input type="text" class="form-control" id="email" name="email" value="<?=set_value('email', $campussetting->email)?>" >
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('address') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                ...
                                <textarea class="form-control" style="resize:none;" id="address" name="address"><?=set_value('address', $campussetting->address)?></textarea>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('footer') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                ...
                                <input type="text" class="form-control" id="footer" name="footer" value="<?=set_value('footer', $campussetting->footer)?>" >
                                <span class="control-label">
                                    <?=form_error('footer'); ?>
                                </span>
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('currency_code') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                ...
                                <input type="text" class="form-control" id="currency_code" name="currency_code" value="<?=set_value('currency_code', $campussetting->currency_code)?>" >
                                <span class="control-label">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('currency_symbol') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                ...
                                <input type="text" class="form-control" id="currency_symbol" name="currency_symbol" value="<?=set_value('currency_symbol', $campussetting->currency_symbol)?>" >
                                <span class="control-label">
                        ...
                        <div class="form-group <?php if(form_error('language_status')) { echo 'has-error'; } ?>">
                            <div class="col-sm-12">
                                ...
                                <?php
                                    ...
                                    echo form_dropdown("language_status", $languageArray, set_value("language_status",$campussetting->language_status), "id='language_status' class='form-control select2'");
                                ?>
                                <span class="control-label">
                        ...
                        <div class="form-group <?=form_error('lang') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                ...
                                <?php
                                    ...
                                    set_value("lang", $campussetting->language), "id='lang' class='form-control select2'");
                                ?>
                                <span class="control-label">
                                    <?=form_error('lang'); ?>
                                </span>
                        ...
                        <div class="form-group <?=form_error('school_year') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                ...
                                <?php
                                    ...
                                    echo form_dropdown("school_year", $array, set_value("school_year",$campussetting->school_year), "id='school_year' class='form-control select2'");
                                ?>
                                <span class="control-label">
                        ...
                        <div class="form-group <?=form_error('attendance') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                ...
                                <?php
                                    ...
                                    echo form_dropdown("attendance", $array, set_value("attendance",$campussetting->attendance), "id='attendance' class='form-control select2'");
                                ?>
                                <span class="control-label">
                                ...
                                <div class="row">
                                    <div id="autoinvoicediv" class="">
                                        <?php
                                            ...
                                            echo form_dropdown("auto_invoice_generate", $array, set_value("auto_invoice_generate",$campussetting->auto_invoice_generate), "id='auto_invoice_generate' class='form-control select2'");
                                        ?>
                                    </div>
                                    <div class="col-sm-6">
                                        <?php
                                            ...
                                            echo form_dropdown("automation", $dayArray, set_value("automation",$campussetting->automation), "id='automation' class='form-control select2'");
                                        ?>
                                    </div>
                                </div>
                                <span class="control-label">
                        ...
                        <div class="form-group <?=form_error('note') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                ...
                                <?php
                                    ...
                                    echo form_dropdown("note", $noteArray, set_value("note",$campussetting->note), "id='note' class='form-control select2'");
                                ?>
                                <span class="control-label">
                                    <?=form_error('note'); ?>
                                </span>
                        ...
                        <div class="form-group <?php if(form_error('weekends')) { echo 'has-error'; } ?>">
                            ...
                            <label><?=$this->lang->line('setting_weekends')?>&nbsp; <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Select Weekends"></i></label>
                                <?php
                                    ...
                                    if(isset($campussetting->weekends)) {
                                        $expHoliday = explode(',', $campussetting->weekends);
                                    } else {
                                        $expHoliday = [];
                                    }
                            ...
                            <div class="col-sm-12">
                                <label for="frontendorbackend"><?=$this->lang->line("setting_school_frontend")?>&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Enable/Disable frontend site"></i>
                                    ...
                                    <?php
                                        ...
                                        set_value("frontendorbackend", $campussetting->frontendorbackend), "id='frontendorbackend' class='form-control select2'");
                                    ?>
                                <span class="control-label">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('google_analytics') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                ...
                                <input type="text" class="form-control" id="google_analytics" name="google_analytics" value="<?=set_value('google_analytics', $campussetting->google_analytics)?>" >
                                <span class="control-label">
                        ...
                        <div class="form-group <?php if(form_error('profile_edit')) { echo 'has-error'; } ?>">
                            <div class="col-sm-12">
                                ...
                                <?php
                                    ...
                                    echo form_dropdown("profile_edit", $profileEditArray, set_value("profile_edit",$campussetting->profile_edit), "id='profile_edit' class='form-control select2'");
                                ?>
                                <span class="control-label">
                                ...
                                <label for="time_zone"><?=$this->lang->line("setting_school_time_zone")?>&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Select your region time zone. We define a time zone as a region where the same standard time is used"></i>
                                    ...
                                    <?php
                                        ...
                                        if(@include($path)) {
                                            ...
                                            echo form_dropdown("time_zone", $timeZones, set_value("time_zone", $campussetting->time_zone), "id='time_zone' class='form-control select2'");
                                        }
                                    ?>
                                <span class="control-label">
                            ...
                            <div class="col-sm-12">
                                <label for="ex_class"><?=$this->lang->line("setting_graduate_class")?>&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="a graduate or former student class of a specific school"></i>
                                    ...
                                    <?php
                                        ...
                                        echo form_dropdown("ex_class", $ex_classArray, set_value("ex_class", $campussetting->ex_class), "id='ex_class' class='form-control select2'");
                                    ?>
                                <span class="control-label">
                                    <?=form_error('ex_class'); ?>
                                </span>
                        ...
                        <div class="form-group <?php if(form_error('auto_update_notification')) { echo 'has-error'; } ?>">
                            <div class="col-sm-12">
                                ...
                                <?php
                                    ...
                                    echo form_dropdown("auto_update_notification", $autoupdateArray, set_value("auto_update_notification",$campussetting->auto_update_notification), "id='auto_update_notification' class='form-control select2'");
                                ?>
                                <span class="control-label">
                            ...
                            <?php
                                if(count($markpercentages)) {
                                    foreach ($markpercentages as $key => $markpercentage) {
                                        ...
                                        if(isset($campussettingarray[$compress])) {
                                            if($campussettingarray[$compress] == 1) {
                                                $checkbox = 'checked';
                                            } else {
                                                $checkbox = ''; 
                                            }
                    ...
                    <div class="form-group <?php if(form_error('captcha_status')) { echo 'has-error'; } ?>">
                        <div class="col-sm-12">
                            ...
                            <?php
                                ...
                                echo form_dropdown("captcha_status", $captchaArray, set_value("captcha_status",$campussetting->captcha_status), "id='captcha_status' class='form-control select2'");
                            ?>
                ...
                <div class="col-sm-4">
                    <div class="form-group <?php if(form_error('recaptcha_site_key')) { echo 'has-error'; } ?>" id="recaptcha_site_key_id">
                        <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control" id="recaptcha_site_key" name="recaptcha_site_key" value="<?=set_value('recaptcha_site_key', $campussetting->recaptcha_site_key)?>" >
                            <span class="control-label">
                ...
                <div class="col-sm-4">
                    <div class="form-group <?php if(form_error('recaptcha_secret_key')) { echo 'has-error'; } ?>" id="recaptcha_secret_key_id" >
                        <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control" id="recaptcha_secret_key" name="recaptcha_secret_key" value="<?=set_value('recaptcha_secret_key', $campussetting->recaptcha_secret_key)?>" >
                            <span class="control-label">
                    ...
                    <div class="form-group <?php if(form_error('attendance_notification')) { echo 'has-error'; } ?>">
                        <div class="col-sm-12">
                            ...
                            <?php
                                ...
                                echo form_dropdown("attendance_notification", $array, set_value("attendance_notification",$campussetting->attendance_notification), "id='attendance_notification' class='form-control select2'");
                            ?>
                            <span class="control-label">
                    ...
                    <div class="form-group <?php if(form_error('attendance_smsgateway')) { echo 'has-error'; } ?>" id="attendance_smsgateway_div">
                        <div class="col-sm-12">
                            ...
                            <?php
                                ...
                                echo form_dropdown("attendance_smsgateway", $array, set_value("attendance_smsgateway",$campussetting->attendance_smsgateway), "id='attendance_smsgateway' class='form-control select2'");
                            ?>
                            <span class="control-label">
                    ...
                    <div class="form-group <?php if(form_error('attendance_notification_template')) { echo 'has-error'; } ?>" id="attendance_notification_template_div">
                        <div class="col-sm-12">
                            ...
                            <?php
                                ...
                                echo form_dropdown("attendance_notification_template", $attendanceNotificationArray, set_value("attendance_notification_template", $campussetting->attendance_notification_template), "id='attendance_notification_template' class='form-control select2'");
                            ?>
                            <span class="control-label">
                        ...
                        <a id="<?=$theme->themesID?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?=$theme->themename?>"
                         ...
                         data-skin="skin-green-light" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4); cursor: pointer;" class="clearfix full-opacity-hover backendThemeEvent">
                            ...
                            <div>
                                ...
                                <?php  ?>
                                        <?php if($campussetting->backend_theme == strtolower(str_replace(' ', '', $theme->themename)))  {?>
...
<script type="text/javascript">
    ...
    $(document).on('change', "#attendance_notification", function() {
        ...
        if(value == 'sms' || value =='email') {
            $.ajax({
                type: 'POST',
                url: "<?=base_url('campussetting/getTemplate')?>",
                data: {"value" : value},
                dataType: "html",
    ...
    $(document).ready(function() {
        $('.backendThemeEvent').click(function() {
            ...
            if(id) {
                $.ajax({
                    type: 'POST',
                    url: "<?=base_url('campussetting/backendtheme')?>",
                    data: "id=" + id,
                    dataType: "html",
                    success: function(data) {
    ...
    <?php if($campussetting->auto_invoice_generate) { ?>
        $('#automation').show();
    ...
    $(document).ready(function() {
        ...
        if(schooltype) {
            $.ajax({
                type: 'POST',
                dataType: "json",
                url: "<?=base_url('campussetting/callschoolyear')?>",
