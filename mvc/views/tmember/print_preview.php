                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="70%"><?=!empty($transport) ? $transport->route : 'N/A'?></td>
                        </tr>
                        <tr>
                            <td width="30%"><?=$this->lang->line("tmember_tfee")?></td>
                            <td width="70%"><?=!empty($tmember) ? $tmember->tbalance : 'N/A'?></td>
                        </tr>
                        <tr>
                            <td width="30%"><?=$this->lang->line("tmember_joindate")?></td>
                            <td width="70%"><?php if(!empty($tmember)) { if($tmember->tjoindate) { echo date("d M Y", strtotime($tmember->tjoindate)); } } else { echo 'N/A'; }   ?></td>
                        </tr>
                        <tr>
