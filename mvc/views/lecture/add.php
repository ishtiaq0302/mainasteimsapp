...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?=base_url("lecture/index")?>"></i> <?=$this->lang->line('menu_lecture')?></a></li>
            <li class="active"><?=$this->lang->line('menu_add')?> <?=$this->lang->line('menu_lecture')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
...
var classesID = "<?php echo set_value('classesID'); ?>";
if(setcampusID==''){
