<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?=base_url("online_exam/index/$campusID")?>"><?=$this->lang->line('panel_title')?></a></li>
...
{ 
    $.ajax({
        ...
        success: function(data) {
            $('#classes').html(data);
            $('#classes option[value="<?=$classesID?>"]').attr('selected','selected');
        }
    }); 
    ...
    $.ajax({
        async: false,
        type: 'POST',
        url: "<?=base_url('universalfunction/studentgroupcall')?>",
        data: "id=" + campusID,
        dataType: "html",
        success: function(data) {
            $('#studentGroup').html(data);
            $('#studentGroup option[value="<?=$studentGroupID?>"]').attr('selected','selected');
        }
    });
} 
