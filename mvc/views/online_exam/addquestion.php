                    ...
                    <div class="col-sm-12">
                        <div class="info-box">
                            ...
                            <p>
                                ...
                                <?=!empty($instruction) ? namesorting($instruction->title,50) : ''?>
                            </p>
                            <p>
                                <span><?=$this->lang->line('online_exam_class')?> : </span>
                                <?=!empty($class) ? $class->classes : ''?>
                            </p>
                            <p>
                            ...
                            <p>
                                ...
                                <?=!empty($studentGroup) ? $studentGroup->group : ''?>
                            </p>
                            <p>
...
<script type="application/javascript">
    $('#groupID').change(function () {
        ...
        $.ajax({
            ...
            data: {"groupID" : groupID, 'levelID': levelID, 'campusID': campusID},
            dataType: "html",
