<div class="row">
        ...
        if($this->session->userdata('usertypeID') == 1)
    {
        ...
        if(!empty($generateBoxArray)) { foreach ($generateBoxArray as $generateBoxArrayKey => $generateBoxValue) { ?>
    

            <div class="col-lg-3 col-xs-6">
                <div class="small-box" style="border-radius: 25px;">
...
<?php if($this->session->userdata('usertypeID') == 3) { ?>
        <div class="row">
  <div class="col-sm-12">
<?php $this->load->view('dashboard/ZoomTimetable', array('val' => 5, 'length' => 15, 'maxlength' => 45)); ?>
  </div>
  </div>
...
<?php if($getActiveUserID == 1 || $getActiveUserID == 5) { ?>
    ...
    <div class="row">
        ...
        <?php } ?>
        <div class="col-sm-6">
            <?php $this->load->view('dashboard/TeacherAttendance', array('val' => 5, 'length' => 15, 'maxlength' => 45)); ?>
        </div>
        <!-- <div class="col-sm-6">
            <div class="box">
                <div class="box-body" style="padding: 0px;">
