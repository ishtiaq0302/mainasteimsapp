        ...
        <div class="box">
            <div class="box-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?=base_url("productpurchase/index/$campusID")?>"><?=$this->lang->line('menu_productpurchase')?></a></li>
...
function getInfoByCampus(campusID)
{
    $.ajax({
        async: false,
        type: 'POST',
        url: "<?=base_url('universalfunction/productcategorycall')?>",
        data: "id=" + campusID,
        dataType: "html",
        success: function(data) {
    ...
    $.ajax({
        async: false,
        type: 'POST',
        url: "<?=base_url('universalfunction/suppliercall')?>",
        data: "id=" + campusID,
        dataType: "html",
        success: function(data) {
            $('#productsupplierID').html(data);
            $('#productsupplierID option[value="<?=$productsupplierID?>"]').attr('selected','selected');
        }
    });
    ...
    $.ajax({
        async: false,
        type: 'POST',
        url: "<?=base_url('universalfunction/warehousecall')?>",
        data: "id=" + campusID,
        dataType: "html",
        success: function(data) {
            $('#productwarehouseID').html(data);
            $('#productwarehouseID option[value="<?=$productwarehouseID?>"]').attr('selected','selected');
        }
    });
}    
