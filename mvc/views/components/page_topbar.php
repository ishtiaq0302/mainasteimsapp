        ...
        <header class="header">
            <a href="<?php echo base_url('dashboard/index'); ?>" class="logo">
               ...
               <!--  <img src="<?=imagelink($this->session->userdata('photo')) 
                                ?>" class="user-logo" style="width:80px; height:50px;" alt=""> -->
               <img src="<?php echo base_url('uploads/images/'.$siteinfos->photo);?>" class="user-logo" style="width:85px; height:50px;" alt="">   
            </a>
