...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?=base_url("salary_template/index/$campusID")?>"><?=$this->lang->line('menu_salary_template')?></a></li>
