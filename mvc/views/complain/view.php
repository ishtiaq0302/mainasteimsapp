<?php if(!empty($complain)) { ?>
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
              <ol class="breadcrumb">
                  ...
                  <li><a href="<?=base_url("complain/index/$campusID")?>"><?=$this->lang->line('menu_complain')?></a></li>
    ...
    <div id="printablediv">
        <div class="row">
                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <?php } elseif($user->usertypeID == 3) { ?>
                                ...
                                <li class="list-group-item" style="background-color: #FFF">
                                    <b><?=$this->lang->line('complain_class')?></b> <a class="pull-right"><?=!empty($classes) ? $classes->classes : ''?></a>
                                </li>
                                <li class="list-group-item" style="background-color: #FFF">
                                    <b><?=$this->lang->line('complain_section')?></b> <a class="pull-right"><?=!empty($section) ? $section->section : ''?></a>
                                </li>
                            <?php } else { ?>
                                <li class="list-group-item" style="background-color: #FFF">
            ...
            <?php } ?>
            <div class="<?php if(!empty($user)) { echo 'col-sm-6 col-mergin'; } else { echo 'col-sm-9'; } ?>">
            ...
            <div class="col-sm-3 <?php if(empty($user)) { echo 'col-mergin'; } ?>">
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        <div class="single_box">
                            ...
                            <p class="text-muted"><?=!empty($createinfo) ? $createinfo->name : '';?></p>
                        </div>
                        <div class="single_box">
                            <strong><?=$this->lang->line('complain_complainer_role');?></strong>
                            <p class="text-muted"><?=!empty($createinfo) ? $createinfo->usertype : '' ?></p>
                        </div>
                    </div>
                </div>
            </div>
