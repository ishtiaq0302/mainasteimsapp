    ...
    <div class="box-body">
        <div class="row">
			<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
				<div class="col-sm-9">
                    <?php getCampus($student->campusID); ?>  
                    ...
                    ?>
                        ...
                        <div class="col-sm-6 classID">
                            <?php
                                ...
                                echo form_dropdown("classesID", $classArray, set_value("classesID", $student->classesID), "id='classesID' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <?php /*
                        ...
                        <div class="col-sm-6">
                            ...
                            <?php
                                ...
                                echo form_dropdown("campusID", $campusArray, set_value("campusID", $student->campusID), "id='campusID' class='form-control select2' required='required' ");
...
getInfoByCampus(<?=$student->campusID?>);
