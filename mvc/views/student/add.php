                     ...
                     <?php /*
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("campusID", $campusArray, set_value("campusID",$campusID), "id='campusID' class='form-control select2'");
...
$('#campusID').change(function(event) {
    ...
    window.location.href = "<?=base_url('student/add/')?>"+campusID;
});
