...
<th class="col-sm-2"><?php echo $this->lang->line('class') . " " . $this->lang->line('title'); ?></th>
<th class="col-sm-2"><?php echo $this->lang->line('date'); ?></th>
<th class="col-sm-1"><?php echo $this->lang->line('api_used_add'); ?></th>
<th class="col-sm-1"><?php echo $this->lang->line('created_by') ?></th>
<th class="col-sm-1"><?php echo $this->lang->line('created_for'); ?></th>
<th class="col-sm-1"><?php echo $this->lang->line('class'); ?></th>
<th class="col-sm-2"><?php echo $this->lang->line('status'); ?></th>
 <th class="col-sm-1"><?php echo $this->lang->line('action'); ?></th>                 
                            </tr>
                        </thead>
                        <tbody>
                                    ...
                                    <td data-title="<?=$this->lang->line('exam_name')?>">
                                         <?php 
                                          if ($conference_value->status == 0) {
                                                    ...
                                                    <?php if(permissionChecker('student_delete_meeting')) 
                                                    { ?>
                                                   <!--  <?php
                                                     echo btn_delete('student/delete_meeting/'.$conference_value->id."/".$return_response->id, $this->lang->line('delete')); 
                                                    ?> -->
                                                 ...
                                                 <?php
                                                    if ($conference_value->api_type != 'self') {
                                                        ?>
                                                              ...
                                                              <a data-placement="left" href="<?php echo base_url(); ?>student/delete_meeting/<?php echo $conference_value->id . "/" . $return_response->id; ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_msg') ?>');">
...
$('#campusID').change(function(event) {
    ...
    window.location.href = "<?=base_url('student/timetable/')?>"+campusID;
});
</script>
