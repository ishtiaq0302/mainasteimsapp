	...
	<div class="well">
	    <div class="row">
	        <div class="col-sm-6">
	            ...
	            <?php if($siteinfos->school_year == $this->session->userdata('defaultschoolyearID')) { if(permissionChecker('student_edit')) { echo btn_sm_edit('student/edit/'.$profile->srstudentID."/".$set."/".$campusID, $this->lang->line('edit')); }} 
	            ?>
		      		...
		      		<div class="box-body box-profile">
		              	...
		              	<ul class="list-group list-group-unbordered">
		              		<li class="list-group-item" style="background-color: #FFF">
		                    	<b><?=$this->lang->line('student_campus')?></b> 
									<a class="pull-right"><?=$campus->name?></a>
		                  	</li>
		              		<li class="list-group-item" style="background-color: #FFF">
		                  	...
		                  	<li class="list-group-item" style="background-color: #FFF">
		                        <b><?=$this->lang->line('student_classes')?></b> <a class="pull-right"><?=!empty($class) ? $class->classes : ''?></a>
		                    </li>
		                    <li class="list-group-item" style="background-color: #FFF">
		                    	<b><?=$this->lang->line('student_section')?></b> <a class="pull-right"><?=!empty($section) ? $section->section : ''?></a>
		                  	</li>
		         		</ul>
		            </div>
		        </div>
		    ...
		    <div class="col-sm-9">
		        <div class="nav-tabs-custom">
		            <ul class="nav nav-tabs">
		              	...
		              	<?php if(!empty($parents)) { ?> <li><a href="#parents" data-toggle="tab"><?=$this->lang->line('student_parents')?></a></li> <?php } ?>
			            	...
			            	<div class="panel-body profile-view-dis">
			            		<div class="row">
				              		<div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_studentgroup")?> </span>: <?=!empty($group) ? $group->group : '' ?></p>
				                    </div>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_optionalsubject")?> </span>: <?=!empty($optionalsubject) ? $optionalsubject->subject : ''?></p>
				                    </div>
				                    <div class="profile-view-tab">
			              	...
			              	<div class="tab-pane" id="invoice">
			              		<div id="hide-table">
				                    <table class="table table-striped table-bordered table-hover">
				                        ...
				                        <tbody>
						              		<?php $totalInvoice = 0; $totalDiscount = 0; $totalPaid = 0; $totalWeaver = 0; $totalDue = 0; $totalFine = 0; if(!empty($invoices)) { $i = 1; foreach ($invoices as $invoice) { ?>
						              			<tr>
			              	...
			              	<div class="tab-pane" id="payment">
			              		<div id="hide-table">
				                    <table class="table table-striped table-bordered table-hover">
				                        ...
				                        <tbody>
						              		<?php $totalPaymentPaid = 0; $totalPaymentWeaver = 0; $totalPaymentFine = 0; if(!empty($payments)) { $i = 1; foreach ($payments as $payment) {  ?>
						              			<tr>
				                                    <td data-title="<?=$this->lang->line('slno')?>">
				                                        <?php echo $i; ?>
				                                    </td>
			              	...
			              	<div class="tab-pane" id="document">
			              		...
			              		<div id="hide-table">
				                    <table class="table table-striped table-bordered table-hover">
				                        ...
				                        <tbody>
						              		<?php if(!empty($documents)) { $i = 1; foreach ($documents as $document) {  ?>
						              			<tr>
				                                    <td data-title="<?=$this->lang->line('slno')?>">
				                                        <?php echo $i; ?>
				                                    </td>
