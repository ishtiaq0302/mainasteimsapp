    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb">
                ...
                <li><a href="<?=base_url("event/index/$campusID")?>"><?=$this->lang->line('menu_event')?></a></li>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
          <table class="table table-bordered">
            ...
            <?php if(!empty($goings)) { $i=1; foreach ($goings as $going) { ?>
              <thead>
                <tr>
                  <td><?=$i?></td>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
          <table class="table table-bordered">
            ...
            <?php if(!empty($ignores)) { $i=1; foreach ($ignores as $ignore) { ?>
              <thead>
                <tr>
                  <td><?=$i?></td>
