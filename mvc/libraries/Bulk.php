...
class Bulk {
	...
	public function __construct () {
        ...
        $bulk_bind = array();
        $get_bulks = $this->ci->smssettings_m->get_smssettings();

        $bulk_bind = array();
		$bulk_bind = array(
			'bulk_username' 		=> $get_bulks['bulk_username'],
			'bulk_password' 		=> $get_bulks['bulk_password'],
			/*'bulk_api_key' 			=> $get_bulks['bulk_api_key'],
			'bulk_senderID' 		=> $get_bulks['bulk_senderID'],*/
		);;
